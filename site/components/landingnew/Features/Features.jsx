...
import rbLogo from '../../../assets/logos/foxbits-logo-small.svg';
import './Features.css';
...
const ROW_A = [
  { name: 'Stipple Surface', cat: 'backgrounds' },
  { name: 'Warp Strings', cat: 'backgrounds' },
  { name: 'Goo Pointer', cat: 'animations' },
  { name: 'Borealis Glow', cat: 'backgrounds' },
  { name: 'Compass Field', cat: 'animations' },
  { name: 'Repel Field', cat: 'animations' },
  { name: 'Sphere Pool', cat: 'backgrounds' },
  { name: 'Square Wake', cat: 'animations' },
  { name: 'Arcane Halos', cat: 'animations' }
];

const ROW_B = [
  { name: 'Sonar Sweep', cat: 'backgrounds' },
  { name: 'Geo Lattice', cat: 'backgrounds' },
  { name: 'Streamers', cat: 'animations' },
  { name: 'Speckle Wash', cat: 'backgrounds' },
  { name: 'Photo Satellites', cat: 'animations' },
  { name: 'Chrome Ink', cat: 'animations' },
  { name: 'Paint Vortex', cat: 'backgrounds' },
  { name: 'Polar Glow', cat: 'backgrounds' },
  { name: 'Ripple Pointer', cat: 'animations' },
  { name: 'Crossing Bands', cat: 'backgrounds' }
];
