...
const ArcField = ({
  ...
  if (geom && layout) {
    ...
    content = (
      ...
      >
        ...
        <path className="arc-field__ring" d={bandPath} fill="none" stroke={accentColor} strokeWidth={borderWidth + 6} />
        ...
        {showButton && (
          ...
          >
            <path className="arc-field__button-bg" d={buttonPath} fill={accentColor} />
  ...
  return (
    <form
      ref={rootRef}
      className={`arc-field ${focused ? 'arc-field--focused' : ''} ${className}`.trim()}
