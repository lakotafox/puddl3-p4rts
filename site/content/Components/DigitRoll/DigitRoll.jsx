...
function Number({ mv, number, height }) {
  ...
  return (
    <motion.span className="digit-roll-number" style={{ y }}>
      {number}
    </motion.span>
  );
}
...
function Digit({ place, value, height, digitStyle }) {
  ...
  if (isDecimal) {
    return (
      <span className="digit-roll-digit" style={{ height, ...digitStyle, width: 'fit-content' }}>
        .
      </span>
    );
  }
  ...
  return (
    <span className="digit-roll-digit" style={{ height, ...digitStyle }}>
...
export default function DigitRoll({
  ...
  return (
    <span className="digit-roll-container" style={containerStyle}>
      <span className="digit-roll-digit-roll" style={{ ...defaultCounterStyle, ...counterStyle }}>
        {places.map(place => (
