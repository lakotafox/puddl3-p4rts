...
import BeamCascade from '@/content/Animations/BeamCascade/BeamCascade';
import { beamCascade } from '@/constants/code/Animations/beamCascadeCode';
  ...
  return (
    ...
    >
      <TabsLayout>
        <PreviewTab>
          ...
          >
            <BeamCascade
              ...
              color={color}
              key={key}
              className={`beam-cascade-demo-${selectedExample}`}
            />
        ...
        <CodeTab>
          <CodeExample codeObject={beamCascade} componentName="BeamCascade" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
...
export default BeamCascadeDemo;
