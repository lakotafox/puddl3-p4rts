...
import CheckerDissolve from '../../content/Animations/CheckerDissolve/CheckerDissolve';
import { checkerDissolve } from '../../constants/code/Animations/checkerDissolveCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={checkerDissolve} componentName="CheckerDissolve" />
        </CodeTab>
      </TabsLayout>
...
export default CheckerDissolveDemo;
