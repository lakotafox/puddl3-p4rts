...
import { filamentWeave } from '../../constants/code/Animations/filamentWeaveCode';
import FilamentWeave from '../../content/Animations/FilamentWeave/FilamentWeave';
    ...
    () => [
      {
        ...
        description: 'Palette of hex colors cycled across the filament-weave. Pass an empty array to use the built-in rainbow spectrum.'
      },
      {
        name: 'count',
        type: 'number',
        default: '3',
        description: 'Number of filament-weave woven through the animation.'
      },
      {
        name: 'speed',
        type: 'number',
        default: '0.5',
        description: 'How quickly the filament-weave ripple and flow.'
      },
      {
        name: 'amplitude',
        type: 'number',
        default: '1',
        description: 'Vertical reach of each filament as it waves up and down.'
      },
      {
        name: 'waviness',
        type: 'number',
        default: '1',
        description: 'Density of the curves along each filament.'
      },
      {
        name: 'thickness',
        type: 'number',
        default: '0.7',
        description: 'Width of each glowing filament.'
      },
      {
        name: 'glow',
        type: 'number',
        default: '2.6',
        description: 'Strength of the luminous bloom around the filament-weave.'
      },
      {
        name: 'taper',
        type: 'number',
        default: '3',
        description: 'How sharply the filament-weave fade out toward the edges.'
      },
      {
        name: 'spread',
        type: 'number',
        default: '1',
        description: 'Separation between filament-weave so they fan out instead of overlapping.'
      },
      {
        name: 'hueShift',
        type: 'number',
        default: '0',
        description: 'Rotates the colors around the filament-weave for variation.'
      },
      {
        name: 'intensity',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '1',
        description: 'Overall transparency of the rendered filament-weave.'
      },
      {
        name: 'scale',
        type: 'number',
        default: '1',
        description: 'Zooms the whole effect in or out to make the filament-weave bigger or smaller.'
      },
      {
        name: 'glass',
        type: 'boolean',
        default: 'false',
        description: 'Renders the filament-weave inside a refractive glass ball.'
      },
      {
        name: 'refraction',
        type: 'number',
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={filamentWeave} componentName="FilamentWeave" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
...
export default FilamentWeaveDemo;
