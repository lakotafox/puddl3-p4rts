...
import { flockPointer } from '../../constants/code/Animations/flockPointerCode';
import FlockPointer from '../../content/Animations/FlockPointer/FlockPointer';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={flockPointer} componentName="FlockPointer" />
        </CodeTab>
      </TabsLayout>
...
export default FlockPointerDemo;
