...
import HazyMorph from '../../content/Animations/HazyMorph/HazyMorph';
import { hazyMorph } from '../../constants/code/Animations/hazyMorphCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={hazyMorph} componentName="HazyMorph" />
        </CodeTab>
      </TabsLayout>
