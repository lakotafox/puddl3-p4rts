...
import LockOnPointer from '../../content/Animations/LockOnPointer/LockOnPointer';
import { lockOnPointer } from '../../constants/code/Animations/lockOnPointerCode';
    ...
    <>
      ...
      >
        <TabsLayout>
          ...
          <CodeTab>
            <CodeExample codeObject={lockOnPointer} componentName="LockOnPointer" />
          </CodeTab>
        </TabsLayout>
      </ComponentPropsProvider>
...
export default LockOnPointerDemo;