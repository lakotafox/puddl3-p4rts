...
import PointerCells from '../../content/Animations/PointerCells/PointerCells';
import { pointerCells } from '../../constants/code/Animations/pointerCellsCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={pointerCells} componentName="PointerCells" />
        </CodeTab>
      </TabsLayout>
...
export default PointerCellsDemo;
