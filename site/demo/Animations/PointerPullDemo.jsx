...
import PointerPull from '../../content/Animations/PointerPull/PointerPull';
import { pointerPull } from '../../constants/code/Animations/pointerPullCode';
    ...
    () => [
      {
        ...
        type: 'number',
        default: 100,
        description: 'Specifies the distance (in pixels) around the element that activates the pointer-pull pull.'
      },
      {
        name: 'disabled',
        type: 'boolean',
        default: false,
        description: 'Disables the pointer-pull effect when set to true.'
      },
      {
        name: 'magnetStrength',
        type: 'number',
      ...
      },
      {
        ...
        description: 'CSS transition applied to the element when the pointer-pull is active.'
      },
      {
        name: 'inactiveTransition',
        type: 'string',
        default: '"transform 0.5s ease-in-out"',
        description: 'CSS transition applied when the pointer-pull is inactive (mouse out of range).'
      },
      {
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" minH={400}>
            <PointerPull padding={Math.floor(padding / 2)} disabled={disabled} magnetStrength={magnetStrength}>
        ...
        <CodeTab>
          <CodeExample codeObject={pointerPull} componentName="PointerPull" />
        </CodeTab>
      </TabsLayout>
...
export default PointerPullDemo;
