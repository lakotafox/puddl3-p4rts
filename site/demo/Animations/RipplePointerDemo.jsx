...
import RipplePointer from '../../content/Animations/RipplePointer/RipplePointer';
import { ripplePointer } from '../../constants/code/Animations/ripplePointerCode';
        ...
        <TabsLayout>
          <PreviewTab>
            ...
            <Flex justify="flex-end" mt={2} mb={-2}>
              <OpenInStudioButton backgroundId="ripple-pointer" currentProps={props} defaultProps={DEFAULT_PROPS} />
            </Flex>
          ...
          <CodeTab>
            <CodeExample codeObject={ripplePointer} componentName="RipplePointer" />
          </CodeTab>
        </TabsLayout>
      </ComponentPropsProvider>
...
export default RipplePointerDemo;
