...
import SpringFabric from '../../content/Animations/SpringFabric/SpringFabric';
import { springFabric } from '../../constants/code/Animations/springFabricCode';
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={springFabric} componentName="SpringFabric" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
...
export default SpringFabricDemo;
