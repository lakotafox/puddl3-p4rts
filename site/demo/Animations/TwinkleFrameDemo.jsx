...
import TwinkleFrame from '../../content/Animations/TwinkleFrame/TwinkleFrame';
import { twinkleFrame } from '../../constants/code/Animations/twinkleFrameCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={400}>
            <TwinkleFrame className="twinkle-frame-demo" color={color} thickness={thickness} speed={`${speed}s`}>
        ...
        <CodeTab>
          <CodeExample codeObject={twinkleFrame} componentName="TwinkleFrame" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
...
export default TwinkleFrameDemo;
