...
import { voltageFrame } from '../../constants/code/Animations/voltageFrameCode';
import VoltageFrame from '../../content/Animations/VoltageFrame/VoltageFrame';
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={voltageFrame} componentName="VoltageFrame" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
...
export default VoltageFrameDemo;
