...
import { voxelCluster } from '../../constants/code/Animations/voxelClusterCode';
import VoxelCluster from '../../content/Animations/VoxelCluster/VoxelCluster';
    ...
    () => [
      {
        ...
        type: 'number',
        default: '10',
        description: 'The size of the grid (number of voxel-cluster per row/column)'
      },
      {
        name: 'cubeSize',
        type: 'number',
        default: 'undefined',
        description: 'Fixed size of each cube in pixels. If not provided, voxel-cluster will be responsive'
      },
      {
        name: 'maxAngle',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '3',
        description: 'Radius of the tilt effect (how many voxel-cluster around the cursor are affected)'
      },
      {
        name: 'easing',
        type: 'string',
      ...
      },
      {
        ...
        type: 'number | object',
        default: 'undefined',
        description: 'Gap between voxel-cluster. Can be a number or object with row/col properties'
      },
      {
        name: 'borderStyle',
        type: 'string',
      ...
      },
      {
        ...
        type: 'boolean | string',
        default: 'false',
        description: 'Shadow effect for voxel-cluster. Can be boolean or custom CSS shadow'
      },
      {
        name: 'autoAnimate',
        type: 'boolean',
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={voxelCluster} componentName="VoxelCluster" />
        </CodeTab>
      </TabsLayout>
...
export default VoxelClusterDemo;
