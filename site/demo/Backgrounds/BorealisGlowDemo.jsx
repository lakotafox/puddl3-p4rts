...
import BorealisGlow from '../../content/Backgrounds/BorealisGlow/BorealisGlow';
import { borealisGlow } from '../../constants/code/Backgrounds/borealisGlowCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={borealisGlow} componentName="BorealisGlow" />
        </CodeTab>
      </TabsLayout>
...
export default BorealisGlowDemo;
