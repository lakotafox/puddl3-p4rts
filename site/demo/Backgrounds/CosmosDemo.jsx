...
import Cosmos from '../../content/Backgrounds/Cosmos/Cosmos';
import { cosmos } from '../../constants/code/Backgrounds/cosmosCode';
    ...
    () => [
      {
        ...
        type: '[number, number]',
        default: '[0.5, 0.5]',
        description: 'Sets the focal point of the cosmos effect as [x, y] coordinates from 0 to 1'
      },
      {
        name: 'rotation',
        type: '[number, number]',
        default: '[1.0, 0.0]',
        description: 'Controls the rotation matrix of the cosmos as [x, y] rotation values'
      },
      {
        name: 'starSpeed',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '1',
        description: 'Controls the density of stars in the cosmos'
      },
      {
        name: 'hueShift',
        type: 'number',
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'true',
        description: 'Enables or disables mouse interaction with the cosmos'
      },
      {
        name: 'glowIntensity',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '0.1',
        description: 'Speed of automatic cosmos rotation'
      },
      {
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={cosmos} componentName="Cosmos" />
        </CodeTab>
      </TabsLayout>
