...
import DriftingWires from '@/content/Backgrounds/DriftingWires/DriftingWires';
import { driftingWires } from '../../constants/code/Backgrounds/driftingWiresCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={driftingWires} componentName="DriftingWires" />
        </CodeTab>
      </TabsLayout>
...
export default DriftingWiresDemo;
