...
import { fluxPool } from '../../constants/code/Backgrounds/fluxPoolCode';
import FluxPool from '../../ts-default/Backgrounds/FluxPool/FluxPool';
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={fluxPool} componentName="FluxPool" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
