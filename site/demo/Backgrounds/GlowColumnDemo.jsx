...
import GlowColumn from '@/content/Backgrounds/GlowColumn/GlowColumn';
import { glowColumn } from '../../constants/code/Backgrounds/glowColumnCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={glowColumn} componentName="GlowColumn" />
        </CodeTab>
      </TabsLayout>
