...
import LatticeBend from '../../content/Backgrounds/LatticeBend/LatticeBend';
import { latticeBend } from '../../constants/code/Backgrounds/latticeBendCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={latticeBend} componentName="LatticeBend" />
        </CodeTab>
      </TabsLayout>
...
export default LatticeBendDemo;
