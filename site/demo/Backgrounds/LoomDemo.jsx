...
import Loom from '../../content/Backgrounds/Loom/Loom';
import { loom } from '../../constants/code/Backgrounds/loomCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} overflow="hidden" p={0}>
            ...
            <BackgroundContent pillText="New Background" headline="Not to be confused with the Loom app by Meta!" />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={loom} componentName="Loom" />
        </CodeTab>
      </TabsLayout>
