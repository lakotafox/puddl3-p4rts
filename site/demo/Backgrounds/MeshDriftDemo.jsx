...
import MeshDrift from '../../content/Backgrounds/MeshDrift/MeshDrift';
import { meshDrift } from '../../constants/code/Backgrounds/meshDriftCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} rounded="3xl" overflow="hidden">
            <MeshDrift items={items} gradientColor={gradientColor} />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="mesh-drift"
        ...
        <CodeTab>
          <CodeExample codeObject={meshDrift} componentName="MeshDrift" />
        </CodeTab>
      </TabsLayout>
