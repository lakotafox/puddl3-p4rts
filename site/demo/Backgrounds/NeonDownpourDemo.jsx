...
import { neonDownpour } from '../../constants/code/Backgrounds/neonDownpourCode';
import NeonDownpour from '../../ts-default/Backgrounds/NeonDownpour/NeonDownpour';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} hasChanges={hasChanges} resetProps={resetProps}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={neonDownpour} componentName="NeonDownpour" />
        </CodeTab>
      </TabsLayout>
...
export default NeonDownpourDemo;
