...
import OilSlick from '../../content/Backgrounds/OilSlick/OilSlick';
import { oilSlick } from '../../constants/code/Backgrounds/oilSlickCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            <OilSlick key={key} speed={speed} color={color} mouseReact={mouseReact} />

            {/* For Demo Purposes Only */}
            <BackgroundContent pillText="New Background" headline="Radiant oil-slick with customizable colors" />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="oil-slick"
        ...
        <CodeTab>
          <CodeExample codeObject={oilSlick} componentName="OilSlick" />
        </CodeTab>
      </TabsLayout>
