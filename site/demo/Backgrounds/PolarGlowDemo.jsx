...
import PolarGlow from '../../content/Backgrounds/PolarGlow/PolarGlow';
import { polarGlow } from '../../constants/code/Backgrounds/polarGlowCode';
    ...
    () => [
      {
        ...
        description: 'An array of three hex colors defining the polar-glow gradient.'
      },
      {
        name: 'speed',
        type: 'number',
        default: '1.0',
        description: 'Controls the animation speed. Higher values make the polar-glow move faster.'
      },
      {
        name: 'blend',
        type: 'number',
        default: '0.5',
        description: 'Controls the blending of the polar-glow effect with the background.'
      },
      {
        name: 'amplitude',
        type: 'number',
        default: '1.0',
        description: 'Controls the height intensity of the polar-glow effect.'
      }
    ],
    []
  );
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            <PolarGlow key={key} blend={blend} speed={speed} colorStops={[color1, color2, color3]} />
        ...
        <CodeTab>
          <CodeExample codeObject={polarGlow} componentName="PolarGlow" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
