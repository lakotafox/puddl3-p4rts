...
import { shutterGlow } from '../../constants/code/Backgrounds/shutterGlowCode';
import ShutterGlow from '../../ts-default/Backgrounds/ShutterGlow/ShutterGlow';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} hasChanges={hasChanges} resetProps={resetProps}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={shutterGlow} componentName="ShutterGlow" />
        </CodeTab>
      </TabsLayout>
...
export default ShutterGlowDemo;
