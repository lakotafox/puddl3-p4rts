...
import SlatRipple from '@/content/Backgrounds/SlatRipple/SlatRipple';
import { slatRipple } from '../../constants/code/Backgrounds/slatRippleCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={slatRipple} componentName="SlatRipple" />
        </CodeTab>
      </TabsLayout>
