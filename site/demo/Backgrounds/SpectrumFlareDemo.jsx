...
import SpectrumFlare from '../../content/Backgrounds/SpectrumFlare/SpectrumFlare';
import { spectrumFlare } from '../../constants/code/Backgrounds/spectrumFlareCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={spectrumFlare} componentName="SpectrumFlare" />
        </CodeTab>
      </TabsLayout>
...
export default SpectrumFlareDemo;
