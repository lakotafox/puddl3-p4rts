...
import BadgeSwing from '../../content/Components/BadgeSwing/BadgeSwing';
import { badgeSwing } from '../../constants/code/Components/badgeSwingCode';
  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        type: 'string',
        default: 'null',
        description: "Custom image URL for the badge-swing band's repeating texture. Falls back to the default band texture when not set."
      },
      {
        name: 'lanyardWidth',
        type: 'number',
        default: '1',
        description: 'Width of the badge-swing band (meshline lineWidth). Increase it to give a custom band image more room and reduce stretching.'
      }
    ],
    []
  );
      ...
      <TabsLayout>
        <PreviewTab>
          ...
          >
            ...
            <BadgeSwing key={key} position={[0, 0, cameraDistance]} gravity={stopGravity ? [0, 0, 0] : [0, -40, 0]} />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={badgeSwing} componentName="BadgeSwing" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
