...
import logo from '../../assets/logos/foxbits-gh-black.svg';

import BloomNav from '../../content/Components/BloomNav/BloomNav';
import { bloomNav } from '../../constants/code/Components/bloomNavCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={bloomNav} componentName="BloomNav" />
        </CodeTab>
      </TabsLayout>
