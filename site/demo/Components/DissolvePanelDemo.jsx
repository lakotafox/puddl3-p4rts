...
import DissolvePanel from '../../content/Components/DissolvePanel/DissolvePanel';
import { dissolvePanel } from '../../constants/code/Components/dissolvePanelCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={dissolvePanel} componentName="DissolvePanel" />
        </CodeTab>
      </TabsLayout>
...
export default DissolvePanelDemo;
