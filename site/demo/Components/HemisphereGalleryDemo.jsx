...
import { hemisphereGallery } from '../../constants/code/Components/hemisphereGalleryCode';
import HemisphereGallery from '../../content/Components/HemisphereGallery/HemisphereGallery';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={hemisphereGallery} componentName="HemisphereGallery" />
        </CodeTab>
      </TabsLayout>
...
export default HemisphereGalleryDemo;
