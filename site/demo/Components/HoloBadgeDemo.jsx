...
import { holoBadge } from '../../constants/code/Components/holoBadgeCode';
import HoloBadge from '../../content/Components/HoloBadge/HoloBadge';
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={holoBadge} componentName="HoloBadge" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
