...
import { hueTiles } from '../../constants/code/Components/hueTilesCode';
import HueTiles from '../../content/Components/HueTiles/HueTiles';
    ...
    () => [
      {
        ...
        type: 'Array',
        default: 'Demo []',
        description: 'Array of HueTilesItem objects to display in the grid'
      },
      {
        name: 'className',
        type: 'string',
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h="auto" overflow="hidden" p={0} py={6}>
            <HueTiles radius={radius} damping={damping} fadeOut={fadeOut} />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={hueTiles} componentName="HueTiles" />
        </CodeTab>
      </TabsLayout>
