...
import { perspectiveRail } from '../../constants/code/Components/perspectiveRailCode';
import PerspectiveRail from '../../content/Components/PerspectiveRail/PerspectiveRail';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={perspectiveRail} componentName="PerspectiveRail" />
        </CodeTab>
      </TabsLayout>
...
export default PerspectiveRailDemo;
