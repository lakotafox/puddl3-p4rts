...
import PivotPanel from '../../content/Components/PivotPanel/PivotPanel';
import { pivotPanel } from '../../constants/code/Components/pivotPanelCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} overflow="hidden">
            <PivotPanel
              ...
              overlayContent={<p className="pivot-panel-demo-text">Kendrick Lamar - GNX</p>}
            />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={pivotPanel} componentName="PivotPanel" />
        </CodeTab>
      </TabsLayout>
