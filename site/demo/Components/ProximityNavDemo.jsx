...
import ProximityNav from '../../content/Components/ProximityNav/ProximityNav';
import { proximityNav } from '../../constants/code/Components/proximityNavCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} overflow="hidden" display="flex" alignItems="center" justifyContent="flex-start" pl={{ base: 6, md: 12 }} py={12}>
            <ProximityNav {...props} items={DEMO_ITEMS} />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={proximityNav} componentName="ProximityNav" />
        </CodeTab>
      </TabsLayout>
...
export default ProximityNavDemo;
