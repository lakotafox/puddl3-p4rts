...
import RevealList from '../../content/Components/RevealList/RevealList';
import { revealList } from '../../constants/code/Components/revealListCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={revealList} componentName="RevealList" />
        </CodeTab>
      </TabsLayout>
