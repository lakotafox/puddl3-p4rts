...
import RubberRange from '../../content/Components/RubberRange/RubberRange';
import { rubberRange } from '../../constants/code/Components/rubberRangeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={rubberRange} componentName="RubberRange" />
        </CodeTab>
      </TabsLayout>
...
export default RubberRangeDemo;
