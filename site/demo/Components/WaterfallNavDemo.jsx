...
import logo from '../../assets/logos/foxbits-gh-white.svg';

import { waterfallNav } from '../../constants/code/Components/waterfallNavCode';
import WaterfallNav from '@content/Components/WaterfallNav/WaterfallNav';
...
const WaterfallNavDemo = () => {
  ...
  const propData = useMemo(
    () => [
      ...
      {
        name: 'items',
        type: 'WaterfallNavItem[]',
        default: '[]',
        description: 'Menu items rendered inside the panel.'
      },
      {
        name: 'socialItems',
        type: 'WaterfallNavSocialItem[]',
        default: '[]',
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={waterfallNav} componentName="WaterfallNav" />
        </CodeTab>
      </TabsLayout>
...
export default WaterfallNavDemo;
