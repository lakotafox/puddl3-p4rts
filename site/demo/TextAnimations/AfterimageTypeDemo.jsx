...
import AfterimageType from '../../content/TextAnimations/AfterimageType/AfterimageType';
import { afterimageType } from '../../constants/code/TextAnimations/afterimageTypeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={afterimageType} componentName="AfterimageType" />
        </CodeTab>
      </TabsLayout>
...
export default AfterimageTypeDemo;
