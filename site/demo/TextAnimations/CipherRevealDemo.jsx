...
import CipherReveal from '../../content/TextAnimations/CipherReveal/CipherReveal';
import { cipherReveal } from '../../constants/code/TextAnimations/cipherRevealCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={cipherReveal} componentName="CipherReveal" />
        </CodeTab>
      </TabsLayout>
...
export default CipherRevealDemo;
