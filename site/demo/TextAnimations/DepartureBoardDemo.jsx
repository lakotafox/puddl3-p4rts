...
import DepartureBoard from '../../content/TextAnimations/DepartureBoard/DepartureBoard';
import { departureBoard } from '../../constants/code/TextAnimations/departureBoardCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={departureBoard} componentName="DepartureBoard" />
        </CodeTab>
      </TabsLayout>
...
export default DepartureBoardDemo;
