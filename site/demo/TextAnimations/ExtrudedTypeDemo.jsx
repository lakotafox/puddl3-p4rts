...
import ExtrudedType from '../../content/TextAnimations/ExtrudedType/ExtrudedType';
import { extrudedType } from '../../constants/code/TextAnimations/extrudedTypeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={extrudedType} componentName="ExtrudedType" />
        </CodeTab>
      </TabsLayout>
...
export default ExtrudedTypeDemo;
