...
import GravityLetters from '../../content/TextAnimations/GravityLetters/GravityLetters';
import { gravityLetters } from '../../constants/code/TextAnimations/gravityLettersCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={gravityLetters} componentName="GravityLetters" />
        </CodeTab>
      </TabsLayout>
...
export default GravityLettersDemo;
