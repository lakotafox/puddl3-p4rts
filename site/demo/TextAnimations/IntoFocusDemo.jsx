...
import IntoFocus from '../../content/TextAnimations/IntoFocus/IntoFocus';
import { intoFocus } from '../../constants/code/TextAnimations/intoFocusCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={intoFocus} componentName="IntoFocus" />
        </CodeTab>
      </TabsLayout>
