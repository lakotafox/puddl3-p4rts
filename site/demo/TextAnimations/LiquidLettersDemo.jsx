...
import LiquidLetters from '../../content/TextAnimations/LiquidLetters/LiquidLetters';
import { liquidLetters } from '../../constants/code/TextAnimations/liquidLettersCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={liquidLetters} componentName="LiquidLetters" />
        </CodeTab>
      </TabsLayout>
...
export default LiquidLettersDemo;
