...
import MagneticInk from '../../content/TextAnimations/MagneticInk/MagneticInk';
import { magneticInk } from '../../constants/code/TextAnimations/magneticInkCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={magneticInk} componentName="MagneticInk" />
        </CodeTab>
      </TabsLayout>
...
export default MagneticInkDemo;
