...
import { ribbonMarquee } from '../../constants/code/TextAnimations/ribbonMarqueeCode';
import RibbonMarquee from '../../content/TextAnimations/RibbonMarquee/RibbonMarquee';

const DEFAULT_PROPS = {
  marqueeText: 'TEXT ✦ LOOPING ✦ TEXT ✦ LOOPING ✦',
  speed: 2,
  curveAmount: 400,
  interactive: true
};

const RibbonMarqueeDemo = () => {
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={ribbonMarquee} componentName="RibbonMarquee" />
        </CodeTab>
      </TabsLayout>
...
export default RibbonMarqueeDemo;
