...
import { riffleType } from '../../constants/code/TextAnimations/riffleTypeCode';
import RiffleType from '@content/TextAnimations/RiffleType/RiffleType';
...
const RiffleTypeDemo = () => {
  const propData = useMemo(
    () => [
      { name: 'text', type: 'string', default: '""', description: 'The text content to riffle-type.' },
      ...
      { name: 'loop', type: 'boolean', default: 'false', description: 'Repeat the riffle-type indefinitely.' },
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={riffleType} componentName="RiffleType" />
        </CodeTab>
      </TabsLayout>
