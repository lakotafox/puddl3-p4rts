...
export const BeamCascade: React.FC<Props> = ({
  className,
  style,
  wispDensity = 1,
  dpr,
  ...
  return <div ref={mountRef} className={`beam-cascade-container ${className || ''}`} style={style} />;
};

export default BeamCascade;
