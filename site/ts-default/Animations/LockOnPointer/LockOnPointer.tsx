...
const LockOnPointer: React.FC<LockOnPointerProps> = ({
  ...
  return (
    <div ref={cursorRef} className="lock-on-pointer-wrapper">
      <div ref={dotRef} className="lock-on-pointer-dot" style={{ backgroundColor: cursorColor }} />
      <div className="lock-on-pointer-corner corner-tl" style={{ borderColor: cursorColor }} />
      <div className="lock-on-pointer-corner corner-tr" style={{ borderColor: cursorColor }} />
      <div className="lock-on-pointer-corner corner-br" style={{ borderColor: cursorColor }} />
      <div className="lock-on-pointer-corner corner-bl" style={{ borderColor: cursorColor }} />
    </div>
  );
};
