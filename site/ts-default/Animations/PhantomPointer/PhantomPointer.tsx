...
import './PhantomPointer.css';

type PhantomPointerProps = {
  className?: string;
...
const PhantomPointer: React.FC<PhantomPointerProps> = ({
  className,
  style,
  trailLength = 50,
  inertia = 0.5,
  ...
  return <div ref={containerRef} className={`phantom-pointer ${className ?? ''}`} style={mergedStyle} />;
};

export default PhantomPointer;
