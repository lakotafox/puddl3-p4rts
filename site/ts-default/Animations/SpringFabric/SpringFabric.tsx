...
export interface SpringFabricProps {
  image?: string;
  color1?: string;
  color2?: string;
  highlight?: string;
...
const SpringFabric = ({
  ...
  return (
    <div ref={containerRef} className={`spring-fabric${className ? ` ${className}` : ''}`} style={style} {...rest} />
  );
};

export default SpringFabric;
