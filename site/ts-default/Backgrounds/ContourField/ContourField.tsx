...
type ContourFieldCtx = {
  renderer: InstanceType<typeof Renderer>;
  program: InstanceType<typeof Program>;
  mesh: InstanceType<typeof Mesh>;
};
const ctxMap = new WeakMap<HTMLDivElement, ContourFieldCtx>();
...
const ContourField: React.FC<ContourFieldProps> = ({
  lowColor = '#5227FF',
  midColor = '#FF9FFC',
  highColor = '#FFFFFF',
  speed = 0.35,
  ...
  return <div ref={containerRef} className={`contour-field-container ${className}`.trim()} />;
};
