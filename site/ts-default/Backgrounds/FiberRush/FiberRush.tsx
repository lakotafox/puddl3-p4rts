...
import './FiberRush.css';

export type FlowDirection = 'inward' | 'outward';

export interface FiberRushProps {
  cableColor?: string;
  pulseColor?: string;
  tunnelColor?: string;
...
const ctxMap = new WeakMap<HTMLDivElement, FiberRushCtx>();

const FiberRush: React.FC<FiberRushProps> = ({
  cableColor = '#A855F7',
  pulseColor = '#A855F7',
  tunnelColor = '#5227FF',
  tunnelOpacity = 0,
  ...
  return <div ref={containerRef} className={`fiber-rush-container ${className}`.trim()} />;
};

export default FiberRush;
