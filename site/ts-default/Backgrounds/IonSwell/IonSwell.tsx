...
export default function IonSwell(props: IonSwellProps) {
  const {
    xOffset = 0,
    yOffset = 0,
    rotationDeg = 0,
  ...
  const propsRef = useRef<IonSwellProps>(props);
  ...
  return <div ref={containerRef} className="ion-swell-container" />;
}
