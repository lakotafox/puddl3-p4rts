...
import './ShutterGlow.css';

export interface ShutterGlowProps {
  className?: string;
  dpr?: number;
  paused?: boolean;
...
const ShutterGlow: React.FC<ShutterGlowProps> = ({
  className,
  dpr,
  paused = false,
  gradientColors,
...
`;
  ...
  return (
    <div
      ref={containerRef}
      className={`shutter-glow-container ${className}`}
      style={{
        ...(mixBlendMode && {
