...
export interface SignalBandsProps {
  color1?: string;
  color2?: string;
  color3?: string;
  speed?: number;
...
const ctxMap = new WeakMap<HTMLDivElement, SignalBandsCtx>();

const SignalBands: React.FC<SignalBandsProps> = ({
  color1 = '#5227FF',
  color2 = '#FF9FFC',
  color3 = '#FFFFFF',
  speed = 0.5,
  ...
  return <div ref={containerRef} className={`signal-bands-container ${className}`.trim()} />;
};
