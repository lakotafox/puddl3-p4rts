...
const StippleSurface = memo(({
  ...
  const glowIdRef = useRef(`stipple-surface-glow-${Math.random().toString(36).slice(2, 9)}`);
  ...
  return (
    <div className="stipple-surface-container" {...rest}>
      <canvas
        ref={canvasRef}
        style={{
          position: 'absolute',
...
StippleSurface.displayName = 'StippleSurface';

export default StippleSurface;
