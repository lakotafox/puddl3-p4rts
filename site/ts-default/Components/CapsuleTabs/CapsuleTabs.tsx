...
const CapsuleTabs: React.FC<CapsuleTabsProps> = ({
  ...
  return (
    <div className="capsule-tabs-container">
      <nav className={`capsule-tabs ${className}`} aria-label="Primary" style={cssVars}>
        ...
        <div className="capsule-tabs-items desktop-only" ref={navItemsRef}>
