...
const LiquidLetters = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('LiquidLetters: WebGL could not be initialized.', error);
      return undefined;
    }
  ...
  return (
    <div ref={containerRef} className={`liquid-letters ${className}`.trim()} style={style} role="img" aria-label={text} />
  );
};

export default LiquidLetters;
