...
import './RiffleType.css';

gsap.registerPlugin(ScrollTrigger, GSAPSplitText, useGSAP);

export interface RiffleTypeProps {
  text: string;
  className?: string;
...
const RiffleType: React.FC<RiffleTypeProps> = ({
  text,
  className = '',
  style = {},
    ...
    () => {
      ...
      const build = () => {
        ...
        splitRef.current = new GSAPSplitText(el, {
          type: 'chars',
          charsClass: 'riffle-type-char',
          wordsClass: 'riffle-type-word',
          linesClass: 'riffle-type-line',
          smartWrap: true,
  ...
  const classes = useMemo(() => `riffle-type-parent ${ready ? 'is-ready' : ''} ${className}`, [ready, className]);
  const Tag = (tag || 'p') as keyof JSX.IntrinsicElements;
  return React.createElement(Tag, { ref: ref as any, className: classes, style: commonStyle }, text);
};

export default RiffleType;
