# MOLT3N — source template

This is the complete source for the **MOLT3N** project, a studio site from the PUDDL3 universe.
It's a Vite project —
...
on the template listing rebuilds this same result as a single self-contained plain-HTML file;
