    ...
    show ? (
      ...
      >
        ...
        <p className="text-sm leading-relaxed text-foreground/70">
          We use cookies to keep the site working, see how it&apos;s used, and
          improve what we ship next. Plain sight, no mystery — accept all, reject
          the non-essential, or pick category by category. See our{" "}
          <Link
            href="/privacy-policy"
            target="_blank"
