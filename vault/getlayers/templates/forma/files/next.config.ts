...
const nextConfig: NextConfig = {
  ...
  // Hide the floating dev-tools badge — it sits over the hero's bottom-left
  // card. Note it also hid a genuine issue counter, so problems now surface
  // only in the console, the terminal, and `yarn lint` / `yarn build`.
  devIndicators: false,
