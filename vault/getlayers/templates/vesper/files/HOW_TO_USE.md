...
This is the complete source for the **PUDDL3** project, distributed as a source template.
It's a Next.js app —
...
on the original listing rebuilds this same result as a single self-contained plain-HTML file;
