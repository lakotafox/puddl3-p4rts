...
export default function ArcaneHalos({
  color = '#fc42ff',
  colorTwo = '#42fcff',
  speed = 1,
  ringCount = 6,
  ...
  const propsRef = useRef<Required<ArcaneHalosProps> | null>(null);
  ...
  return <div ref={mountRef} className="arcane-halos-container" style={blur > 0 ? { filter: `blur(${blur}px)` } : undefined} />;
}
