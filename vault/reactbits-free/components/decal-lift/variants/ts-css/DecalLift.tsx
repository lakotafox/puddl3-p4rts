...
import './DecalLift.css';

gsap.registerPlugin(Draggable);

interface DecalLiftProps {
  imageSrc: string;
  rotate?: number;
...
interface CSSVars extends CSSProperties {
  ...
  '--decal-lift-easing'?: string;
  '--decal-lift-hover-easing'?: string;
...
const DecalLift: React.FC<DecalLiftProps> = ({
  imageSrc,
  rotate = 30,
  peelBackHoverPct = 30,
  ...
  const cssVars: CSSVars = useMemo(
    () => ({
      ...
      '--decal-lift-easing': peelEasing,
      '--decal-lift-hover-easing': peelHoverEasing,
