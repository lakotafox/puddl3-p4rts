...
import './FocalFibers.css';

export type FanMode = 'center' | 'left' | 'right';

export interface FocalFibersProps {
  color1?: string;
  color2?: string;
  color3?: string;
  speed?: number;
...
const ctxMap = new WeakMap<HTMLDivElement, FocalFibersCtx>();

const FocalFibers: React.FC<FocalFibersProps> = ({
  color1 = '#5227FF',
  color2 = '#FF9FFC',
  color3 = '#FFFFFF',
  speed = 0.2,
  ...
  return <div ref={containerRef} className={`focal-fibers-container ${className}`.trim()} />;
};

export default FocalFibers;
