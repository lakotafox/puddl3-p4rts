...
import './HorizonSwells.css';

export type HorizonSwellsDetail = 'low' | 'medium' | 'high';

export interface HorizonSwellsProps {
  horizonColor?: string;
  waveColor?: string;
  crestColor?: string;
  speed?: number;
...
const detailToSteps = (detail: HorizonSwellsDetail): number => {
...
type HorizonSwellsCtx = {
  renderer: InstanceType<typeof Renderer>;
  program: InstanceType<typeof Program>;
  mesh: InstanceType<typeof Mesh>;
};
const ctxMap = new WeakMap<HTMLDivElement, HorizonSwellsCtx>();

const HorizonSwells: React.FC<HorizonSwellsProps> = ({
  horizonColor = '#5227FF',
  waveColor = '#FF9FFC',
  crestColor = '#FFFFFF',
  speed = 0.4,
  ...
  return <div ref={containerRef} className={`horizon-swells-container ${className}`.trim()} />;
};

export default HorizonSwells;
