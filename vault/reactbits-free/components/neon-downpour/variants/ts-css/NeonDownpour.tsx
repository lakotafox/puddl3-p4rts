...
import './NeonDownpour.css';

export interface NeonDownpourProps {
  className?: string;
  dpr?: number;
  paused?: boolean;
  colors?: string[];
...
const NeonDownpour: React.FC<NeonDownpourProps> = ({
  className,
  dpr,
  paused = false,
  ...
  return (
    <div
      ref={containerRef}
      className={`neon-downpour-container ${className ?? ''}`}
      style={{
