...
type PhotoWakeConstructor =
  | typeof PhotoWakeVariant1
  | typeof PhotoWakeVariant2
  | typeof PhotoWakeVariant3
  | typeof PhotoWakeVariant4
  | typeof PhotoWakeVariant5
  | typeof PhotoWakeVariant6
  | typeof PhotoWakeVariant7
  | typeof PhotoWakeVariant8;

const variantMap: Record<number, PhotoWakeConstructor> = {
  1: PhotoWakeVariant1,
  2: PhotoWakeVariant2,
  3: PhotoWakeVariant3,
  4: PhotoWakeVariant4,
...
interface PhotoWakeProps {
  items?: string[];
  variant?: number;
}

export default function PhotoWake({ items = [], variant = 1 }: PhotoWakeProps): JSX.Element {
