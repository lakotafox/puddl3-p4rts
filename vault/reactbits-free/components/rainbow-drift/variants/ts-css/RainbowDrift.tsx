...
import './RainbowDrift.css';

type RainbowDriftProps = {
  className?: string;
...
export default function RainbowDrift({
  className,
  style,
  rotation = 90,
  speed = 0.2,
  ...
  return <div ref={containerRef} className={`rainbow-drift-container ${className}`} style={style} />;
}
