...
const RippleLines: React.FC<RippleLinesProps> = ({
  lineColor = 'black',
  ...
  return (
    <div
      ref={containerRef}
      className={`ripple-lines ${className}`}
      style={{
        position: 'absolute',
        top: 0,
        left: 0,
    ...
    >
      <canvas ref={canvasRef} className="ripple-lines-canvas" />
    </div>
  );
};

export default RippleLines;
