...
import './SpeckleWash.css';

interface SpeckleWashProps {
  timeSpeed?: number;
  colorBalance?: number;
  warpStrength?: number;
...
const ctxMap = new WeakMap<HTMLDivElement, SpeckleWashCtx>();

const SpeckleWash: React.FC<SpeckleWashProps> = ({
  timeSpeed = 0.25,
  colorBalance = 0.0,
  warpStrength = 1.0,
  warpFrequency = 5.0,
  ...
  return <div ref={containerRef} className={`speckle-wash-container ${className}`.trim()} />;
};

export default SpeckleWash;
