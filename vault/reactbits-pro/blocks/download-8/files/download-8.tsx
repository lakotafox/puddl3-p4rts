  ...
  return (
    <section className="w-full bg-white px-4 py-16 dark:bg-neutral-950 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
      ...
      >
        ...
        >
          Releases, environment checks, and team scripts: run from the terminal
          your engineers already live in.
        </motion.p>
                ...
                <div className="min-h-[132px] sm:min-h-[120px]">
                  <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                      ...
                      <motion.li
                        variants={outputLine}
                        className="pt-1.5 text-neutral-100"
                      >
                        → run{" "}
                        <span className="rounded-md bg-white/10 px-1.5 py-0.5">
                          orbit init
                        </span>{" "}
                        to link your workspace
                      </motion.li>
                    </motion.ul>
                  </AnimatePresence>
                </div>
