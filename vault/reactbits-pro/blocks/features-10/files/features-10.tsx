...
const nodes = [
  { name: "Repositories", icon: Github, x: 50, y: 10 },
  { name: "Observability", icon: Activity, x: 84.6, y: 30 },
  { name: "Cloud", icon: Cloud, x: 84.6, y: 70 },
  { name: "Alerting", icon: Bell, x: 50, y: 90 },
  { name: "Datastores", icon: Database, x: 15.4, y: 70 },
  { name: "CI / CD", icon: Terminal, x: 15.4, y: 30 },
];
...
export function Features10() {
  ...
  return (
    <section className="w-full overflow-hidden bg-white px-4 py-16 dark:bg-neutral-950 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
      <div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 items-center gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
        ...
        >
          ...
          >
            Every tool you run, wired into one hub
          </motion.h2>
          ...
          >
            Code, clouds, pipelines, datastores, and alerting meet in one calm
            control plane. Relay listens to every source and routes each signal
          ...
          >
            <button className="w-full cursor-pointer rounded-full bg-black px-6 py-3 text-sm font-medium text-white transition-colors duration-200 hover:bg-neutral-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900 focus-visible:ring-offset-2 dark:bg-white dark:text-black dark:hover:bg-neutral-200 dark:focus-visible:ring-white dark:focus-visible:ring-offset-neutral-950 sm:w-auto sm:px-8 sm:py-3.5 sm:text-base">
              Connect a source
            </button>
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-80px" }}
          role="img"
          aria-label="Service map showing repositories, observability, cloud, alerting, datastores, and CI/CD connected to the Relay hub"
