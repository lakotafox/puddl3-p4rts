...
const scrollbarHideStyles = `
  .profile-2-scrollbar-hide::-webkit-scrollbar {
    display: none;
  }
`;
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-4xl shadow-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 p-2">
            ...
            <div className="relative px-4 pb-4">
              ...
              <motion.div
                ...
                className="border-b border-neutral-200 dark:border-neutral-800 mb-6 overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0 profile-2-scrollbar-hide"
                style={{
                  scrollbarWidth: "none",
                ...
                >
                  <div className="bg-neutral-50 dark:bg-neutral-800/50 rounded-xl p-4 sm:p-5">
                    ...
                    <p className="text-sm text-neutral-600 dark:text-neutral-300 leading-relaxed">
                      I&apos;m Alex Rivera, a Full Stack Developer passionate
                      about building fast, scalable, and user-friendly web
                      applications. I love solving complex technical challenges
                      and creating elegant solutions through clean code. Always
                      learning, I explore new frameworks and technologies to
