...
import "./aura-deck.css";

export interface AuraDeckProps {
...
const AuraDeck: React.FC<AuraDeckProps> = ({
  images = [
  ...
  return (
    <div
      ref={containerRef}
      className={`aura-deck-container ${isDragging ? "dragging" : ""} ${className}`}
      style={{
        perspective: "1800px",
      }}
    >
      {isLoading && (
        <div className="aura-deck-loader">
          <div className="aura-deck-loader-content">
            <div className="aura-deck-loader-spinner" />
          </div>
        </div>
      )}
      ...
      <div ref={cardsContainerRef} className="aura-deck-cards">
        {stableImages.map((src, i) => (
          ...
          >
            <img
              ...
              className="aura-deck-card-image"
              draggable={false}
            />
          </div>
        ))}
