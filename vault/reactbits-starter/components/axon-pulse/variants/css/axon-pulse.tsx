...
export interface AxonPulseProps {
  speed?: number;
  scale?: number;
  intensity?: number;
  color?: string;
...
const AxonPulse: React.FC<AxonPulseProps> = ({
  speed = 0.5,
  scale = 0.5,
  intensity = 2,
  color = "#FF9FFC",
  ...
  return (
    <div className={`axon-pulse-container ${className || ""}`}>
      <Canvas
        orthographic
