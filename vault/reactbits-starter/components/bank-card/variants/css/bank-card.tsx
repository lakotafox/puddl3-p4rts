...
export const BankCard: React.FC<BankCardProps> = ({
  ...
  return (
    <motion.div
      className={`bank-card-wrapper-animated ${className || ""}`}
    ...
    >
      <div
        ref={wrapperRef}
        className="bank-card-container-wrapper"
        style={{
          width: `${width}px`,
          height: `${height}px`,
      ...
      >
        <motion.div
          ...
          className={`bank-card-main ${isActive ? "active-state" : ""} ${cardClassName || ""}`}
          style={{
            borderRadius: `${borderRadius}px`,
          }}
          animate={{
        ...
        >
          {showShadow && (
            <motion.div
              className={`bank-card-shadow ${isActive ? "active" : ""}`}
              style={{
                borderRadius: `${borderRadius}px`,
              }}
              animate={{
          ...
          <div
            className="bank-card-face bank-card-front"
            style={{
              borderRadius: `${borderRadius}px`,
            }}
          >
            <div
              ...
              className="bank-card-background-layer"
              style={{
                background,
                borderRadius: `${borderRadius}px`,
              }}
            ...
            <div
              ref={contentLayerRef}
              className="bank-card-content-layer"
              style={{
                borderRadius: `${borderRadius}px`,
                color: textColor,
            ...
            >
              <div className="bank-card-top-row">
                <div
                  className="bank-card-chip-container"
                ...
                >
                  {chipImage && (
                    <img
                      src={chipImage}
                      alt="Card chip"
                      className="bank-card-chip-image"
                      style={{
                ...
                {cardLogo && (
                  <img
                    src={cardLogo}
                    alt="Card logo"
                    className="bank-card-logo-image"
                    style={{
              ...
              <div
                className="bank-card-number-row"
                style={{
              ...
              >
                {displayCardNumber.split(" ").map((group, groupIdx) => (
                  <span key={groupIdx} className="bank-card-number-group">
                    {group.split("").map((char, charIdx) => (
                      <motion.span
                        ...
                        className="bank-card-number-char"
                      >
                        {char}
                      </motion.span>
                    ))}
              ...
              <div
                className="bank-card-bottom-row"
                style={{
                  fontSize: fontSize.text,
                }}
              >
                <div className="bank-card-info-column">
                  <span
                    className="bank-card-label"
                    style={{
                  ...
                  <span
                    className="bank-card-cardholder-name"
                    style={{
                      textShadow: hasTextShadow
                        ? "0 2px 4px rgba(0, 0, 0, 0.3)"
                        : "none",
                ...
                <div className="bank-card-info-column-right">
                  <span
                    className="bank-card-label"
                    style={{
                      fontSize: fontSize.label,
                  ...
                  <span
                    className="bank-card-expiry-container"
                    style={{
                      textShadow: hasTextShadow
                        ? "0 2px 4px rgba(0, 0, 0, 0.3)"
                        : "none",
                  ...
                  >
                    {displayExpirationDate.split("").map((char, idx) => (
                      <motion.span
                        ...
                        className="bank-card-expiry-char"
                      >
                        {char}
                      </motion.span>
                    ))}
          ...
          <div
            className="bank-card-face bank-card-back"
            style={{
              borderRadius: `${borderRadius}px`,
          ...
          >
            ...
            <div
              className="bank-card-back-content"
              style={{
                borderRadius: `${borderRadius}px`,
                color: textColor,
              }}
            >
              <div
                className="bank-card-magnetic-stripe"
                style={{
                  height: `${40 * scale}px`,
              ...
              <div
                className="bank-card-cvv-section"
                style={{
                  paddingLeft: spacing.padding,
                }}
              >
                <div
                  className="bank-card-cvv-box"
                  style={{
                    width: `${120 * scale}px`,
                    height: `${40 * scale}px`,
          ...
          {showShine && (
            <div
              className="bank-card-glow-wrapper"
              style={{
                borderRadius: `${borderRadius}px`,
              }}
            >
      ...
      {showActionButtons && (
        <div className={`bank-card-action-buttons ${buttonsClassName || ""}`}>
          <button
            onClick={() => setIsDetailsVisible(!isDetailsVisible)}
            className="bank-card-action-button"
            title={isDetailsVisible ? "Hide details" : "Show details"}
          >
            {isDetailsVisible ? (
              <Eye className="bank-card-button-icon" />
            ) : (
              <EyeOff className="bank-card-button-icon" />
            )}
          </button>
          <button
            onClick={handleCopyCardNumber}
            disabled={!isDetailsVisible}
            className={`bank-card-action-button ${!isDetailsVisible ? "disabled" : ""}`}
            title={
              isDetailsVisible
                ? copySuccess
                  ? "Copied!"
          ...
          >
            {copySuccess ? (
              <Check className="bank-card-button-icon success" />
            ) : (
              <Copy className="bank-card-button-icon" />
            )}
          </button>
        </div>
      )}
