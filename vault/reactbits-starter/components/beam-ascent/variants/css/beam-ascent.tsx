...
import "./beam-ascent.css";

export interface BeamAscentProps {
...
export const BeamAscent = ({
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        float haloIntensity = computeRadialGlow(
          transformedUV,
          vec2(0.0, -1.0),
          vec2(1.0, 10.0),
          1.2,
        ...
        haloGlow *= haloIntensity;

        vec3 effectColor = uColor * combinedEffect * haloGlow;
        vec3 composedColor = (effectColor + horizonGlow) * vignetteMask * uBrightness;
  ...
  return (
    <div ref={containerRef} className={`beam-ascent ${className || ""}`} />
  );
};

export default BeamAscent;
