...
export interface BreathingMatrixProps {
...
export const BreathingMatrix = ({
  ...
  return (
    <div
      ref={shell}
      className={["breathing-matrix", className].filter(Boolean).join(" ")}
    >
      <div className="breathing-matrix-canvas">
        <Canvas
          orthographic
          dpr={ceiling}
      ...
      {children ? (
        <div className="breathing-matrix-content">{children}</div>
      ) : null}
    </div>
  );
};

export default BreathingMatrix;
