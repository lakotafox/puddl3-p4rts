...
const CascadeType = forwardRef<CascadeTypeHandle, CascadeTypeProps>(
  (
    {
      text,
      className = "",
    ...
    return (
      <Wrapper
        ...
        className={`cascade-type ${hasMultipleRows || segmentBy === "lines" ? "cascade-type--block" : "cascade-type--flex"} ${className}`}
      >
...
CascadeType.displayName = "CascadeType";

export default CascadeType;
