...
import "./color-shift-card.css";

export interface ColorShiftCardProps {
...
const ColorShiftCard: React.FC<ColorShiftCardProps> = ({
  width = "100%",
  height = "100%",
  className = "",
  children,
  ...
  const containerClassName = className
    ? `color-shift-card-container ${className}`
    : "color-shift-card-container";
  ...
  return (
    ...
    >
      <Canvas
        ...
        className="color-shift-card-canvas"
        gl={{
          antialias: true,
          alpha: true,
      ...
      {children && <div className="color-shift-card-content">{children}</div>}
    </div>
  );
};

ColorShiftCard.displayName = "ColorShiftCard";

export default ColorShiftCard;
