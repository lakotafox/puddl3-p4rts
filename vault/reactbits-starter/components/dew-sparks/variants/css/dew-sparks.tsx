...
import "./dew-sparks.css";

export interface DewSparksProps {
...
const DewSparks: React.FC<DewSparksProps> = ({
  width = "100%",
  height = "100%",
  speed = 0.3,
  color = "#5227FF",
  ...
  return (
    <div
      className={`dew-sparks-container ${className}`}
      style={{
        width: widthStyle,
        height: heightStyle,
      }}
    >
      <div ref={containerRef} className="dew-sparks-canvas" />
      {children && <div className="dew-sparks-content">{children}</div>}
    </div>
  );
};

DewSparks.displayName = "DewSparks";

export default DewSparks;
