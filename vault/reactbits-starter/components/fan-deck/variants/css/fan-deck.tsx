...
const FanDeck = ({
  ...
  return (
    <div
      ref={shell}
      className={["fan-deck", className].filter(Boolean).join(" ")}
      style={style}
      onPointerLeave={leave}
    >
      <div
        className="fan-deck-rig"
        style={{
