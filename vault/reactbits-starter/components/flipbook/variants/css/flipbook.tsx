...
export const Flipbook = ({
  ...
  return (
    <section
      ...
      className={["flipbook", className].filter(Boolean).join(" ")}
      style={{ height: `${runway}vh` }}
    >
      <div className="flipbook__pin">
        <div
        ...
        >
          <canvas ref={canvasRef} className="flipbook__canvas" />

          {showCounter && (
            <div
              className="flipbook__counter"
          ...
          {loading && (
            <div
              className="flipbook__loader"
              style={{ backgroundColor: background }}
            >
              {slip ? (
                <span
                  className="flipbook__fault"
                  style={{ color: accent, opacity: 0.55 }}
                >
                  {slip}
                </span>
              ) : (
                <div className="flipbook__loader-inner">
                  <span
                    className="flipbook__loader-track"
                    style={{ backgroundColor: `${accent}26` }}
                  >
                    <span
                      className="flipbook__loader-fill"
                      style={{
                  ...
                  <span
                    className="flipbook__loader-pct"
