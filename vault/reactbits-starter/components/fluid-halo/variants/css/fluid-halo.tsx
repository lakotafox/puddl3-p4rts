...
import "./fluid-halo.css";

export interface FluidHaloProps {
...
export const FluidHalo = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`fluid-halo ${className || ""}`}
      style={{
        width: widthStyle,
        height: heightStyle,
    ...
    >
      <canvas ref={canvasRef} className="fluid-halo__canvas" />
      {children && <div className="fluid-halo__content">{children}</div>}
    </div>
  );
};

export default FluidHalo;
