...
export interface GatewayProps {
  ...
  className?: string;
  /** Primary gateway glow color */
  primaryColor?: string;
  /** Secondary gateway glow color */
  ...
  brightness?: number;
  /** Scale/zoom of the gateway effect */
  scale?: number;
...
export const Gateway = ({
  ...
  return <div ref={containerRef} className={`gateway-container ${className}`} />;
};
