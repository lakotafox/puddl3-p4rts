...
import "./glass-orb-wipe.css";

export interface GlassOrbWipeProps {
  images: string[];
...
export const GlassOrbWipe: React.FC<GlassOrbWipeProps> = ({
  images,
  ...
  return (
    <div className={`glass-orb-wipe-container ${className}`} onClick={advance}>
      <canvas
        ref={canvasEl}
        className="glass-orb-wipe-canvas"
        style={{ opacity: loaded ? 1 : 0 }}
      />
      {!loaded && (
        <div className="glass-orb-wipe-loader">
          <div className="glass-orb-wipe-loader-text">Loading...</div>
        </div>
      )}
    </div>
  );
