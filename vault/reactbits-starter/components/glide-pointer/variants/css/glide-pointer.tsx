...
import "./glide-pointer.css";

export interface GlidePointerProps {
  className?: string;
  pointsCount?: number;
  lineWidth?: number;
...
const GlidePointer: React.FC<GlidePointerProps> = ({
  className = "",
  pointsCount = 40,
  lineWidth = 0.3,
  springStrength = 0.4,
  ...
  return (
    <div className={`glide-pointer-container ${className}`}>
      <canvas ref={canvasRef} className="glide-pointer-canvas" />
    </div>
  );
};

GlidePointer.displayName = "GlidePointer";

export default GlidePointer;
