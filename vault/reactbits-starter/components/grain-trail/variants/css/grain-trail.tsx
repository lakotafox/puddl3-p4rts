...
export interface GrainTrailProps {
  ditherSize?: number;
  radius?: number;
  exponent?: number;
  decay?: number;
...
const GrainTrail: React.FC<GrainTrailProps> = ({
  ditherSize = 2.0,
  radius = 0.1,
  exponent = 2.0,
  decay = 0.01,
  ...
  return (
    <div className={`grain-trail-container ${className || ""}`}>
      <Canvas
        orthographic
