...
import "./ink-threads.css";

export interface InkThreadsProps {
...
const InkThreads: React.FC<InkThreadsProps> = ({
  width = "100%",
  height = "100%",
  className = "",
  speed = 0.4,
  ...
  const containerClassName = className
    ? `ink-threads-container ${className}`
    : "ink-threads-container";
...
InkThreads.displayName = "InkThreads";

export default InkThreads;
