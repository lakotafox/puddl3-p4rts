...
import "./leaf-turn.css";
import { memo, useCallback, useState, type CSSProperties } from "react";
import { motion, useMotionValue, useTransform } from "motion/react";

export interface LeafTurnLeaf {
  id?: string;
  front: string;
  back: string;
  frontAlt?: string;
...
export interface LeafTurnProps {
...
const DEFAULT_PAGES: LeafTurnLeaf[] = [
  {
    id: "atrium",
    front:
...
const LeafTurn = ({
  ...
  return (
    <div
      className={["leaf-turn", className].filter(Boolean).join(" ")}
