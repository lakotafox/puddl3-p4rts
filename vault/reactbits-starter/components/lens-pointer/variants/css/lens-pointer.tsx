...
import "./lens-pointer.css";

const MAX_TRAIL = 40;

interface LensPointerProps {
  /** Container width */
  width?: string | number;
  /** Container height */
...
const LensPointer: React.FC<LensPointerProps> = ({
  width = "100%",
  height = "100%",
  className,
  children,
  ...
  const containerClassName = className
    ? `lens-pointer-container ${className}`
    : "lens-pointer-container";
  ...
  return (
    ...
    >
      ...
      {children && <div className="lens-pointer-overlay">{children}</div>}
    </div>
  );
};

LensPointer.displayName = "LensPointer";

export default LensPointer;
