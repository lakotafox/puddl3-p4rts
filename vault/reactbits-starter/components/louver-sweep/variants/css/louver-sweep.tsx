...
export const LouverSweep = ({
  ...
  return (
    <div
      ref={shell}
      className={["louver-sweep", className].filter(Boolean).join(" ")}
    >
      <div className="louver-sweep-canvas">
        <Canvas
          orthographic
          dpr={ceiling}
      ...
      {children ? (
        <div className="louver-sweep-content">{children}</div>
      ) : null}
    </div>
  );
};
