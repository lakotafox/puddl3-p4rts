...
export interface MarkerRevealProps {
...
export interface MarkerRevealRef {
...
export const MarkerReveal = React.forwardRef<
  MarkerRevealRef,
  MarkerRevealProps
>(
  (
    ...
    return (
      <motion.span
        ...
        className={`marker-reveal-container ${className}`}
      >
...
MarkerReveal.displayName = "MarkerReveal";
