...
import "./molten-pane.css";

interface MoltenPaneProps {
...
const MoltenPane: React.FC<MoltenPaneProps> = ({
  width = "100%",
  height = "100%",
  className = "",
  ...
  const containerClassName = className
    ? `molten-pane-container ${className}`
    : "molten-pane-container";
...
MoltenPane.displayName = "MoltenPane";

export default MoltenPane;
