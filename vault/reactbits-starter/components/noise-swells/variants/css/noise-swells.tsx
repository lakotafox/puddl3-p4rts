...
import "./noise-swells.css";

export interface NoiseSwellsProps {
...
const NoiseSwells: React.FC<NoiseSwellsProps> = ({
  width = "100%",
  height = "100%",
  speed = 0.5,
  color = "#FFFFFF",
  ...
  return (
    <div
      className={`noise-swells-container ${className || ""}`}
      style={{
        width: widthStyle,
        height: heightStyle,
      }}
    >
      <div ref={containerRef} className="noise-swells-canvas" />
      {children && <div className="noise-swells-content">{children}</div>}
    </div>
  );
};

NoiseSwells.displayName = "NoiseSwells";

export default NoiseSwells;
