...
export interface PanelCascadeProps {
...
export const PanelCascade = ({
  ...
  return (
    <div
      ref={shell}
      className={["panel-cascade", className].filter(Boolean).join(" ")}
    >
      <div className="panel-cascade-canvas">
        <Canvas
          orthographic
          dpr={ceiling}
      ...
      {children ? <div className="panel-cascade-content">{children}</div> : null}
    </div>
  );
};
