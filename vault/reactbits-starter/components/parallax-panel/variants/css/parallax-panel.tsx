...
const ParallaxPanel: React.FC<ParallaxPanelProps> = ({
  ...
  return (
    <CardWrapper
      ...
      className={`parallax-panel-wrapper ${onClick || href ? "parallax-panel-clickable" : ""} ${className || ""}`}
      style={{
        width: `${width}px`,
        height: `${height}px`,
        perspective: "1000px",
    ...
    >
      <div
        ref={innerRef}
        className={`parallax-panel ${isHovered ? "parallax-panel-hovered" : ""}`}
        style={{
          borderRadius,
      ...
      >
        <div
          className="parallax-panel-bg-container"
          style={{
            position: "absolute",
            inset: 0,
            overflow: "hidden",
        ...
        <div
          className={`parallax-panel-info parallax-panel-info-p-4 ${contentClassName || ""}`}
        >
          <div className="parallax-panel-gradient" />

          <div className="parallax-panel-content parallax-panel-content-pb-4">
            <h3
              className="parallax-panel-title"
              style={{
            ...
            {description && (
              <p
                className="parallax-panel-description"
                style={{
                  transform: isHovered ? "translateY(0)" : "translateY(4px)",
...
ParallaxPanel.displayName = "ParallaxPanel";
