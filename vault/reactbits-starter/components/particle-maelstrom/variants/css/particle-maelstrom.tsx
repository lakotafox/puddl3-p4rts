...
import "./particle-maelstrom.css";

export interface ParticleMaelstromProps {
...
export const ParticleMaelstrom: React.FC<ParticleMaelstromProps> = ({
  className,
  discCount = 50,
  particleCount = 10000,
  ...
  return (
    <div ref={wrapperRef} className={`particle-maelstrom-container ${className || ""}`}>
      <canvas ref={canvasRef} className="particle-maelstrom-canvas" />
    </div>
  );
};

export default ParticleMaelstrom;
