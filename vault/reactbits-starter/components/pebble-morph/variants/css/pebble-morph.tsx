...
import "./pebble-morph.css";

export interface PebbleMorphProps {
...
const PebbleMorph: React.FC<PebbleMorphProps> = ({
  width = "100%",
  height = "100%",
  className,
  speed = 0.3,
  ...
  const containerClassName = className
    ? `pebble-morph-container ${className}`
    : "pebble-morph-container";
...
PebbleMorph.displayName = "PebbleMorph";

export default PebbleMorph;
