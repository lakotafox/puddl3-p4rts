...
export interface PeekLinksProps {
...
const PeekLinks = ({
      ...
      if (targets[placeholderIndex]) {
        ...
        parts.push(
          <span
            ...
            className={`peek-links-target ${targetClassName}`}
            style={{
  ...
  return (
    <div className={`peek-links-container ${className}`}>
      {renderContent()}
      ...
      <motion.div
        ...
        className="peek-links-image-wrapper"
      >
        <AnimatePresence mode="popLayout" initial={false}>
          {hoveredIndex !== null && targets[hoveredIndex] && (
            <motion.div
              ...
              className="peek-links-image-inner"
            >
              <img
                ...
                width={imageWidth}
                height={imageHeight}
                className={`peek-links-image ${showImageShadow ? "peek-links-image-shadow" : ""}`}
                style={{
...
PeekLinks.displayName = "PeekLinks";

export default PeekLinks;
