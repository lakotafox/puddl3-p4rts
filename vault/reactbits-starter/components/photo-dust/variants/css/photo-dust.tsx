...
const PhotoDust: React.FC<PhotoDustProps> = ({
  ...
  return (
    <div
      ref={root}
      className={["photo-dust-root", className].filter(Boolean).join(" ")}
      style={{ width, height, backgroundColor }}
    >
      <Canvas
        className="photo-dust-canvas"
      ...
      {children && <div className="photo-dust-content">{children}</div>}
    </div>
  );
};

export default PhotoDust;
