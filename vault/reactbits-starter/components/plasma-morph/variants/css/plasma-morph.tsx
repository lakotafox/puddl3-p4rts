...
import "./plasma-morph.css";

export interface PlasmaMorphProps {
...
const PlasmaMorph: React.FC<PlasmaMorphProps> = ({
  size = 400,
  animationSpeed = 1.0,
  glowIntensity = 0.8,
  noiseScale = 3.0,
  ...
  return (
    <div
      className={`plasma-morph-container ${className}`}
      style={{ width: size, height: size, ...style }}
    >
      <div ref={containerRef} className="plasma-morph-canvas plasma-morph-transparent" />
    </div>
  );
};

export default PlasmaMorph;
