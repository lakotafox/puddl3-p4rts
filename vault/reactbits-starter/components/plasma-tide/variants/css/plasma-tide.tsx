...
import "./plasma-tide.css";

export interface PlasmaTideProps {
...
const PlasmaTide: React.FC<PlasmaTideProps> = ({
  width = "100%",
  height = "100%",
  speed = 1.0,
  color1 = "#00ff88",
  ...
  return (
    <div
      className={`plasma-tide-container ${className}`}
      style={{
        width: widthStyle,
        height: heightStyle,
      }}
    >
      <div ref={containerRef} className="plasma-tide-canvas" />
      {children && <div className="plasma-tide-content">{children}</div>}
    </div>
  );
};

PlasmaTide.displayName = "PlasmaTide";

export default PlasmaTide;
