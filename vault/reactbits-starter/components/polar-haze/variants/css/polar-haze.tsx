...
export interface PolarHazeProps {
...
const PolarHaze: React.FC<PolarHazeProps> = ({
  width = "100%",
  height = "100%",
  className,
  children,
  ...
  const containerClassName = className
    ? `polar-haze-container ${className}`
    : "polar-haze-container";
  ...
  return (
    ...
    >
      ...
      {children && <div className="polar-haze-content">{children}</div>}
    </div>
  );
};

PolarHaze.displayName = "PolarHaze";

export default PolarHaze;
