...
export interface PolarSweepProps {
...
export const PolarSweep = ({
  ...
  return (
    <div
      ref={shell}
      className={["polar-sweep", className].filter(Boolean).join(" ")}
    >
      <div className="polar-sweep-canvas">
        <Canvas
          orthographic
          dpr={ceiling}
      ...
      {children ? <div className="polar-sweep-content">{children}</div> : null}
    </div>
  );
};

export default PolarSweep;
