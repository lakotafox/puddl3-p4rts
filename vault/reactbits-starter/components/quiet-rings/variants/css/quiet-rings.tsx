...
export interface QuietRingsProps {
...
export const QuietRings = ({
  ...
  return (
    <div
      ref={shell}
      className={["quiet-rings", className].filter(Boolean).join(" ")}
    >
      <div className="quiet-rings-canvas">
        <Canvas
          orthographic
          dpr={ceiling}
      ...
      {children ? (
        <div className="quiet-rings-content">{children}</div>
      ) : null}
    </div>
  );
};

export default QuietRings;
