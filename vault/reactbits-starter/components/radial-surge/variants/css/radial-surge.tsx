...
export interface RadialSurgeProps {
...
const RadialSurge: React.FC<RadialSurgeProps> = ({
  ...
  const containerClassName = className
    ? `radial-surge-container ${className}`
    : "radial-surge-container";

  const defaultCenterContent = (
    <div
      className="radial-surge-icon-wrapper"
      style={{ width: centerSize * 0.5, height: centerSize * 0.5 }}
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
        className="radial-surge-icon"
  ...
  const defaultNodeContent = (
    <div
      className="radial-surge-node-dot"
      style={{
  ...
  return (
    ...
    >
      <svg className="radial-surge-svg" style={{ overflow: "visible" }}>
        <defs>
      ...
      <div ref={glowRef} className="radial-surge-center" style={centerStyle}>
...
RadialSurge.displayName = "RadialSurge";

export default RadialSurge;
