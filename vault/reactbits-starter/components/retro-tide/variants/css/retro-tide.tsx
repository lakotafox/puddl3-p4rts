...
import "./retro-tide.css";

export interface RetroTideProps {
...
const RetroTide: React.FC<RetroTideProps> = ({
  width = "100%",
  height = "100%",
  speed = 1.0,
  intensity = 1.0,
  ...
  const containerClasses = `retro-tide-container ${className}`.trim();
  ...
  return (
    ...
    >
      {children && <div className="retro-tide-children">{children}</div>}
    </div>
  );
};

export default RetroTide;
