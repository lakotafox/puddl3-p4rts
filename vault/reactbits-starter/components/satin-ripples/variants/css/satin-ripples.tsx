...
import "./satin-ripples.css";

export interface SatinRipplesProps {
...
const SatinRipples: React.FC<SatinRipplesProps> = ({
  speed = 1,
  scale = 2,
  distortion = 1,
  curve = 1,
  ...
  return (
    <div
      ref={containerRef}
      className={`satin-ripples-container ${className || ""}`}
      style={{ minHeight: "inherit", ...style }}
    />
  );
};

export default SatinRipples;
