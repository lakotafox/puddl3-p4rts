...
export interface SlantedLanesProps {
...
export const SlantedLanes = ({
  ...
  return (
    <div
      ...
      className={[
        "slanted-lanes",
        interactive ? "slanted-lanes-grab" : "",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
    ...
    >
      <div className="slanted-lanes-canvas">
      ...
      {children ? <div className="slanted-lanes-content">{children}</div> : null}
    </div>
  );
};

export default SlantedLanes;
