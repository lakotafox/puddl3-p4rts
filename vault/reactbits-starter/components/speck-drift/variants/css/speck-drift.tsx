...
export interface SpeckDriftProps {
  speed?: number;
  scale?: number;
  color?: string;
  size?: number;
...
const SpeckDrift: React.FC<SpeckDriftProps> = ({
  speed = 0.5,
  scale = 0.6,
  color = "#FF9FFC",
  size = 0.6,
  ...
  return (
    <div className={`speck-drift-container ${className || ""}`}>
      <Canvas
        orthographic
