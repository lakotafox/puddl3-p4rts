...
export const SpinReel: React.FC<SpinReelProps> = ({
  images = [],
  radiusPercent = 38,
  itemWidth = 280,
  itemHeight = 400,
  ...
  const defaultImages = [
    ...
    "https://images.unsplash.com/photo-1559666126-84f389796568?w=500&auto=format&fit=crop&q=60",
  ...
  return (
    <div
      ref={containerRef}
      className={`spin-reel-container ${className || ""}`}
      style={{
        perspective: "2200px",
        cursor: enableDrag && !focusedIndex ? "grab" : "auto",
      }}
      onClick={handleContainerClick}
    >
      <div
        ref={wheelRef}
        className={`spin-reel-wheel`}
      ...
      >
        {displayItems.map((image, index) => (
          <div
            ...
            className={`spin-reel-item ${focusedIndex === index ? "focused" : ""} ${itemClassName || ""}`}
            style={{
              width: `${itemWidth}px`,
          ...
          >
            {showNumbers && (
              <div className="spin-reel-item-number">
