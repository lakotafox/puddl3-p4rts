...
import "./spiral-bend.css";

export interface SpiralBendProps {
  /** Tube radius */
  radius?: number;
...
const SpiralBend: React.FC<SpiralBendProps> = ({
  radius = 1.5,
  narrow = 1.8,
  length = 10,
  hazeSpeed = 0.5,
  ...
  const containerClassName = className
    ? `spiral-bend-container ${className}`
    : "spiral-bend-container";
...
SpiralBend.displayName = "SpiralBend";

export default SpiralBend;
