...
export interface SpringCapsulesProps {
...
const SpringCapsules: React.FC<SpringCapsulesProps> = ({
  pills = DEFAULT_PILLS,
  ...
  return (
    <div
      ref={containerRef}
      className={["spring-capsules-root", className].filter(Boolean).join(" ")}
      style={{ width, height }}
    >
      {!disableEmptyPills &&
...
SpringCapsules.displayName = "SpringCapsules";

export default SpringCapsules;
