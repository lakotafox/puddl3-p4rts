...
import "./star-rush.css";

export interface StarRushProps {
...
const StarRush: React.FC<StarRushProps> = ({
  width = "100%",
  height = "100%",
  speed = 1.0,
  primaryColor = "#FF5722",
  ...
  const containerClasses = `star-rush-container ${className}`.trim();
  ...
  return (
    ...
    >
      {children && <div className="star-rush-children">{children}</div>}
    </div>
  );
};
