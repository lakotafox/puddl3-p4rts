...
import "./stardust-swirl.css";

export interface StardustSwirlProps {
...
const StardustSwirl: React.FC<StardustSwirlProps> = ({
  width = "100%",
  height = "100%",
  speed = 1.0,
  color = "#ffffff",
  ...
  return (
    <div
      className={`stardust-swirl-container ${className}`}
      style={{
        width: widthStyle,
        height: heightStyle,
      }}
    >
      <div ref={containerRef} className="stardust-swirl-canvas" />
      {children && <div className="stardust-swirl-content">{children}</div>}
    </div>
  );
};

StardustSwirl.displayName = "StardustSwirl";

export default StardustSwirl;
