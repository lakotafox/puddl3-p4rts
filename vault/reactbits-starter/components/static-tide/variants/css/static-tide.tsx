...
import "./static-tide.css";

export interface StaticTideProps {
...
const StaticTide: React.FC<StaticTideProps> = ({
  width = "100%",
  height = "100%",
  className,
  speed = 0.5,
  ...
  const containerClassName = className
    ? `static-tide-container ${className}`
    : "static-tide-container";
...
StaticTide.displayName = "StaticTide";

export default StaticTide;
