  ...
  function TaggedPointer(
    ...
    return (
      <div
        ...
        className={join(
          "tagged-pointer-root",
          fullScreen ? "tagged-pointer-root--full" : null,
          classNames?.root,
          className,
        )}
        style={surfaceStyle}
      ...
      >
        ...
        <div className="tagged-pointer-layer" style={layerStyle} aria-hidden>
          <AnimatePresence>
            {showCursor && (
              <>
                <motion.div
                  key="tagged-pointer-arrow"
                  className={join("tagged-pointer-follower", classNames?.cursor)}
                  style={{
                    x: cursorX,
                    y: cursorY,
                ...
                >
                  <div className={join("tagged-pointer-arrow", classNames?.arrow)}>
                    {renderedArrow}
                  </div>
                </motion.div>
                ...
                {showLabel && (
                  <motion.div
                    key="tagged-pointer-label"
                    className={join("tagged-pointer-follower", classNames?.label)}
                    style={{
                      x: labelX,
                      y: labelY,
