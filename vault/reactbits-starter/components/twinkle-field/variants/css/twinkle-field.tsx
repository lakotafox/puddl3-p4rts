...
import "./twinkle-field.css";

export interface TwinkleFieldProps {
  ...
  overlayColor?: string;
  /** Minimum twinkle-field frequency */
  minFrequency?: number;
  /** Maximum twinkle-field frequency */
  maxFrequency?: number;
  ...
  jitter?: boolean;
  /** Probability that a particle will twinkle-field (0-1). 0 = static, 1 = all twinkle-field */
  flickerChance?: number;
  /** Whether mouse proximity affects particles */
  mouseEffect?: boolean;
}

export const TwinkleField = ({
  className,
  spacing = 20,
  particleSize = 1.5,
  color = "#5A4B81",
  ...
  return (
    <div ref={containerRef} className={`twinkle-field-wrapper ${className || ""}`}>
      <canvas ref={canvasRef} className="twinkle-field-canvas" />
    </div>
  );
};

export default TwinkleField;
