...
const WispSphere = ({
  ...
  return (
    <div
      ref={rootRef}
      className={["wisp-sphere", className].filter(Boolean).join(" ")}
      style={{
        width,
        height,
    ...
    >
      ...
      {children ? <div className="wisp-sphere-content">{children}</div> : null}
    </div>
  );
};
