...
FocusPullMemo.PRESETS = PRESETS;
FocusPullMemo.CURVE_FUNCTIONS = CURVE_FUNCTIONS;
...
const injectStyles = () => {
  ...
  .focus-pull { pointer-events: none; transition: opacity 0.3s ease-out; }
  .focus-pull-parent { overflow: hidden; }
  .focus-pull-inner { pointer-events: none; }`;
