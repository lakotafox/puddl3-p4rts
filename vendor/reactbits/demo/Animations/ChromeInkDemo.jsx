...
import logo from '../../assets/logos/foxbits-logo-small-black.svg';
import CodeExample from '../../components/code/CodeExample';
import useForceRerender from '../../hooks/useForceRerender';

import PropTable from '../../components/common/Preview/PropTable';

import ChromeInk from '../../content/Animations/ChromeInk/ChromeInk';
import { chromeInk } from '../../constants/code/Animations/chromeInkCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={chromeInk} componentName="ChromeInk" />
        </CodeTab>
      </TabsLayout>
