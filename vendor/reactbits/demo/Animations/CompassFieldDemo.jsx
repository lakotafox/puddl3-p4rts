...
import CompassField from '../../content/Animations/CompassField/CompassField';
import { compassField } from '../../constants/code/Animations/compassFieldCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={compassField} componentName="CompassField" />
        </CodeTab>
      </TabsLayout>
...
export default CompassFieldDemo;
