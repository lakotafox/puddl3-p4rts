...
import logo from '../../assets/logos/foxbits-sticker.png';
import Dependencies from '../../components/code/Dependencies';

import DecalLift from '../../content/Animations/DecalLift/DecalLift';
import { decalLift } from '../../constants/code/Animations/decalLiftCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={decalLift} componentName="DecalLift" />
        </CodeTab>
      </TabsLayout>
