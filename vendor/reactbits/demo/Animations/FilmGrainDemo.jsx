...
import FilmGrain from '../../content/Animations/FilmGrain/FilmGrain';
import { filmGrain } from '../../constants/code/Animations/filmGrainCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={filmGrain} componentName="FilmGrain" />
        </CodeTab>
      </TabsLayout>
