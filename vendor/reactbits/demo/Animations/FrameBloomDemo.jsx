...
import FrameBloom from '@/content/Animations/FrameBloom/FrameBloom';
import { frameBloom } from '@/constants/code/Animations/frameBloomCode';

const DEMO_SRC = 'https://picsum.photos/seed/frame-bloom/1600/1000';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        <PreviewTab>
          ...
          <Customize>
            <PreviewSelect
              title="Title"
              options={[
                { label: 'ROOM TO GROW', value: 'ROOM TO GROW' },
        ...
        <CodeTab>
          <CodeExample codeObject={frameBloom} componentName="FrameBloom" />
        </CodeTab>
      </TabsLayout>
