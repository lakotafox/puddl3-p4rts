...
import NewsprintLens from '@/content/Animations/NewsprintLens/NewsprintLens';
import { newsprintLens } from '@/constants/code/Animations/newsprintLensCode';

const DEFAULT_PROPS = {
  src: 'https://picsum.photos/seed/newsprint-lens/1200/800',
  inkColor: '#141414',
  paperColor: '#fff7e6',
  mode: 'mono',
  dotSize: 1,
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={newsprintLens} componentName="NewsprintLens" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
...
export default NewsprintLensDemo;
