...
import PhantomPointer from '@/content/Animations/PhantomPointer/PhantomPointer';
import { phantomPointer } from '@/constants/code/Animations/phantomPointerCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={phantomPointer} componentName="PhantomPointer" />
        </CodeTab>
      </TabsLayout>
...
export default PhantomPointerDemo;
