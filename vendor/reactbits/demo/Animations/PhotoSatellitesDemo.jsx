...
import PhotoSatellites from '../../content/Animations/PhotoSatellites/PhotoSatellites';
import { photoSatellites } from '../../constants/code/Animations/photoSatellitesCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={photoSatellites} componentName="PhotoSatellites" />
        </CodeTab>
      </TabsLayout>
...
export default PhotoSatellitesDemo;
