...
import { photoWake } from '../../constants/code/Animations/photoWakeCode';
import PhotoWake from '../../content/Animations/PhotoWake/PhotoWake';
      ...
      <TabsLayout>
        <PreviewTab>
          ...
          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton backgroundId="photo-wake" currentProps={{ variant }} defaultProps={DEFAULT_PROPS} />
          </Flex>
        ...
        <CodeTab>
          <CodeExample codeObject={photoWake} componentName="PhotoWake" />
        </CodeTab>
      </TabsLayout>
