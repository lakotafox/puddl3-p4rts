...
import Reticle from '../../content/Animations/Reticle/Reticle';
import { reticle } from '../../constants/code/Animations/reticleCode';
...
const ReticleDemo = () => {
  ...
  const propData = useMemo(
    () => [
      { name: 'color', type: 'string', default: "'white'", description: 'Color of the reticle lines.' },
      {
        name: 'containerRef',
        type: 'RefObject<HTMLElement>',
        default: 'null',
        description:
          'Optional container ref to limit reticle to specific element. If null, reticle will be active on entire viewport.'
      }
    ],
    []
  );
      ...
      <TabsLayout>
        <PreviewTab>
          <Box ref={containerRef} position="relative" className="demo-container" minH={300} overflow="hidden">
            <Reticle containerRef={targeted ? null : containerRef} color={color} />
        ...
        <CodeTab>
          <CodeExample codeObject={reticle} componentName="Reticle" />
        </CodeTab>
      </TabsLayout>
