...
import ShardSwitch from '../../content/Animations/ShardSwitch/ShardSwitch';
import { shardSwitch } from '../../constants/code/Animations/shardSwitchCode';
import './ShardSwitchDemo.css';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        <PreviewTab>
          <Box className="demo-container" minH={500} p={{ base: 4, md: 8 }}>
            <ShardSwitch
              ...
              secondContent={
                <div className="shard-switch-demo__panel shard-switch-demo__panel--second">
                  <span className="shard-switch-demo__eyebrow">Now go and</span>
                  <h3 className="shard-switch-demo__title">Build anything</h3>
                </div>
              }
              pattern={pattern}
              pixelSize={pixelSize}
        ...
        <CodeTab>
          <CodeExample codeObject={shardSwitch} componentName="ShardSwitch" />
        </CodeTab>
      </TabsLayout>
...
export default ShardSwitchDemo;
