...
import SquareWake from '../../content/Animations/SquareWake/SquareWake';
import { squareWake } from '../../constants/code/Animations/squareWakeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={squareWake} componentName="SquareWake" />
        </CodeTab>
      </TabsLayout>
