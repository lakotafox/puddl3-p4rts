...
import WaterWarp from '@/content/Animations/WaterWarp/WaterWarp';
import { waterWarp } from '@/constants/code/Animations/waterWarpCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={waterWarp} componentName="WaterWarp" />
        </CodeTab>
      </TabsLayout>
