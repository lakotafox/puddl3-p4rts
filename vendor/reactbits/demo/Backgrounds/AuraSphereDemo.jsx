...
import { auraSphere } from '../../constants/code/Backgrounds/auraSphereCode';
import AuraSphere from '../../content/Backgrounds/AuraSphere/AuraSphere';
    ...
    () => [
      {
        ...
        type: 'number',
        default: '0',
        description: 'The base hue for the aura-sphere (in degrees).'
      },
      {
        name: 'hoverIntensity',
        type: 'number',
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Force hover animations even when the aura-sphere is not actually hovered.'
      },
      {
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent pillText="New Background" headline="This aura-sphere is hiding something, try hovering!" />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="aura-sphere"
          ...
          <Customize>
            ...
            <PreviewColorPickerCustom title="AuraSphere Background Color" color={backgroundColor} onChange={val => updateProp('backgroundColor', val)} />
          </Customize>
        ...
        <CodeTab>
          <CodeExample codeObject={auraSphere} componentName="AuraSphere" />
        </CodeTab>
      </TabsLayout>
