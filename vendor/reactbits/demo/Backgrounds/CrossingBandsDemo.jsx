...
import { crossingBands } from '../../constants/code/Backgrounds/crossingBandsCode';
import CrossingBands from '../../content/Backgrounds/CrossingBands/CrossingBands';
  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        type: 'number',
        default: '12',
        description: 'Number of crossing-bands to display.'
      },
      {
        name: 'lightColor',
        type: 'string',
      ...
      },
      {
        ...
        type: 'number',
        default: '0',
        description: 'Rotation of the entire crossing-bands system in degrees.'
      }
    ],
    []
  );
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} overflow="hidden" p={0}>
            ...
            <BackgroundContent pillText="New Background" headline="Radiant crossing-bands for creative user interfaces" />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="crossing-bands"
        ...
        <CodeTab>
          <CodeExample codeObject={crossingBands} componentName="CrossingBands" />
        </CodeTab>
      </TabsLayout>
...
export default CrossingBandsDemo;
