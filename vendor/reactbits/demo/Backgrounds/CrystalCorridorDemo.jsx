...
import CrystalCorridor from '@/content/Backgrounds/CrystalCorridor/CrystalCorridor';
import { crystalCorridor } from '../../constants/code/Backgrounds/crystalCorridorCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={crystalCorridor} componentName="CrystalCorridor" />
        </CodeTab>
      </TabsLayout>
...
export default CrystalCorridorDemo;
