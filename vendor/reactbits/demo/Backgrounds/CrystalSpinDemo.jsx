...
import { crystalSpin } from '../../constants/code/Backgrounds/crystalSpinCode';
import CrystalSpin from '../../content/Backgrounds/CrystalSpin/CrystalSpin';
    ...
    () => [
      {
        ...
        type: 'number',
        default: '3.5',
        description: 'Apex height of the crystal-spin (world units).'
      },
      {
        name: 'baseWidth',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '3.6',
        description: 'Overall screen-space scale of the crystal-spin (bigger = larger).'
      },
      {
        name: 'hueShift',
        type: 'number',
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={crystalSpin} componentName="CrystalSpin" />
        </CodeTab>
      </TabsLayout>
...
export default CrystalSpinDemo;
