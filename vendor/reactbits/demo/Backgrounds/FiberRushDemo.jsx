...
import FiberRush from '@/content/Backgrounds/FiberRush/FiberRush';
import { fiberRush } from '../../constants/code/Backgrounds/fiberRushCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={fiberRush} componentName="FiberRush" />
        </CodeTab>
      </TabsLayout>
