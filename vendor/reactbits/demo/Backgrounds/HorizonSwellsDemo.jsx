...
import HorizonSwells from '@/content/Backgrounds/HorizonSwells/HorizonSwells';
import { horizonSwells } from '../../constants/code/Backgrounds/horizonSwellsCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={horizonSwells} componentName="HorizonSwells" />
        </CodeTab>
      </TabsLayout>
...
export default HorizonSwellsDemo;
