...
import { inkCurrents } from '@/constants/code/Backgrounds/inkCurrentsCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={inkCurrents} componentName="InkCurrents" />
        </CodeTab>
      </TabsLayout>
...
export default InkCurrentsDemo;
