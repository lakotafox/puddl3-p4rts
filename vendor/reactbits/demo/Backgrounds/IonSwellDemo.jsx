...
import IonSwell from '../../content/Backgrounds/IonSwell/IonSwell';
import { ionSwell } from '../../constants/code/Backgrounds/ionSwellCode';
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={ionSwell} componentName="IonSwell" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
