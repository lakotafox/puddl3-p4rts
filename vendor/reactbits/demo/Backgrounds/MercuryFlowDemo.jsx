...
import MercuryFlow from '../../content/Backgrounds/MercuryFlow/MercuryFlow';
import { mercuryFlow } from '../../constants/code/Backgrounds/mercuryFlowCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            <MercuryFlow baseColor={baseColor} amplitude={amplitude} speed={speed} interactive={interactive} />
        ...
        <CodeTab>
          <CodeExample codeObject={mercuryFlow} componentName="MercuryFlow" />
        </CodeTab>
      </TabsLayout>
...
export default MercuryFlowDemo;
