...
import MoteField from '../../content/Backgrounds/MoteField/MoteField';
import { moteField } from '../../constants/code/Backgrounds/moteFieldCode';
    ...
    () => [
      {
        ...
        type: 'number',
        default: '200',
        description: 'The number of mote-field to generate.'
      },
      {
        name: 'particleSpread',
        type: 'number',
        default: '10',
        description: 'Controls how far mote-field are spread from the center.'
      },
      {
        name: 'speed',
        type: 'number',
      ...
      },
      {
        ...
        type: 'string[]',
        default: "['#ffffff']",
        description: 'An array of hex color strings used to color the mote-field.'
      },
      {
        name: 'moveParticlesOnHover',
        type: 'boolean',
        default: 'false',
        description: 'Determines if mote-field should move in response to mouse hover.'
      },
      {
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'If true, mote-field are rendered with varying transparency; otherwise, as solid circles.'
      },
      {
        name: 'particleBaseSize',
        type: 'number',
        default: '100',
        description: 'The base size of the mote-field.'
      },
      {
        name: 'sizeRandomness',
        type: 'number',
        default: '1',
        description: 'Controls the variation in particle sizes (0 means all mote-field have the same size).'
      },
      {
        name: 'cameraDistance',
        type: 'number',
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent pillText="New Background" headline="MoteField that mimick the dance of the cosmos" />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="mote-field"
              currentProps={{
                particleCount,
                particleSpread,
                speed,
        ...
        <CodeTab>
          <CodeExample codeObject={moteField} componentName="MoteField" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
