...
import { nebulaDrift } from '../../constants/code/Backgrounds/nebulaDriftCode';
import NebulaDrift from '../../ts-default/Backgrounds/NebulaDrift/NebulaDrift';
    ...
    () => [
      {
        ...
        type: 'string',
        default: 'undefined',
        description: 'Optional hex color to tint the nebula-drift effect. If not provided, uses original colors.'
      },
      {
        name: 'speed',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '1.0',
        description: 'Zoom level of the nebula-drift pattern. Higher values zoom in.'
      },
      {
        name: 'opacity',
        type: 'number',
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether the nebula-drift responds to mouse movement.'
      },
      {
        name: 'renderScale',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '60',
        description: 'Raymarch step count — lower is cheaper but less detailed. Higher values produce smoother nebula-drift.'
      }
    ],
    []
  );
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            />
            <BackgroundContent pillText="New Background" headline="Minimal nebula-drift waves that soothe the eyes" />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="nebula-drift"
        ...
        <CodeTab>
          <CodeExample codeObject={nebulaDrift} componentName="NebulaDrift" />
        </CodeTab>
      </TabsLayout>
...
export default NebulaDriftDemo;
