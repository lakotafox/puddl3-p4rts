...
import { rainbowDrift } from '@/constants/code/Backgrounds/rainbowDriftCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={rainbowDrift} componentName="RainbowDrift" />
        </CodeTab>
      </TabsLayout>
...
export default RainbowDriftDemo;
