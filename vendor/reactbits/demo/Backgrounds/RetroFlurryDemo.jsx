...
import { retroFlurry } from '../../constants/code/Backgrounds/retroFlurryCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={retroFlurry} componentName="RetroFlurry" />
        </CodeTab>
      </TabsLayout>
...
export default RetroFlurryDemo;
