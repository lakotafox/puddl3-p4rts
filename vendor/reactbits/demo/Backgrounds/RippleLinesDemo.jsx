...
import RippleLines from '../../content/Backgrounds/RippleLines/RippleLines';
import { rippleLines } from '../../constants/code/Backgrounds/rippleLinesCode';
  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        type: 'string',
        default: 'transparent',
        description: 'Sets the background color of the ripple-lines container.'
      },
      {
        name: 'waveSpeedX',
        type: 'number',
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" h={500} className="demo-container" overflow="hidden" p={0}>
            <RippleLines key={key} waveSpeedX={waveSpeedX} lineColor={lineColor} />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="ripple-lines"
              currentProps={{
                lineColor,
                waveSpeedX
              }}
          ...
          <Customize onRerender={forceRerender}>
            ...
            <PreviewColorPickerCustom title="RippleLines Color" color={lineColor} onChange={val => updateProp('lineColor', val)} />
          </Customize>
        ...
        <CodeTab>
          <CodeExample codeObject={rippleLines} componentName="RippleLines" />
        </CodeTab>
      </TabsLayout>
...
export default RippleLinesDemo;
