...
import { satinFlow } from '../../constants/code/Backgrounds/satinFlowCode';
import SatinFlow from '../../content/Backgrounds/SatinFlow/SatinFlow';
    ...
    () => [
      {
        ...
        type: 'number',
        default: '5',
        description: 'Controls the animation speed of the satin-flow effect.'
      },
      {
        name: 'scale',
        type: 'number',
        default: '1',
        description: 'Controls the scale of the satin-flow pattern.'
      },
      {
        name: 'color',
        type: 'string',
        default: "'#7B7481'",
        description: 'Hex color code for the satin-flow pattern.'
      },
      {
        name: 'noiseIntensity',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '0',
        description: 'Controls the rotation of the satin-flow pattern (in radians).'
      }
    ],
    []
  );
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} overflow="hidden" p={0}>
            ...
            <BackgroundContent pillText="New Background" headline="SatinFlow touch is a good enhancement, Steve!" />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="satin-flow"
        ...
        <CodeTab>
          <CodeExample codeObject={satinFlow} componentName="SatinFlow" />
        </CodeTab>
      </TabsLayout>
