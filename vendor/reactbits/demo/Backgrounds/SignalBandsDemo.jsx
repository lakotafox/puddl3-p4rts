...
import SignalBands from '@/content/Backgrounds/SignalBands/SignalBands';
import { signalBands } from '../../constants/code/Backgrounds/signalBandsCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={signalBands} componentName="SignalBands" />
        </CodeTab>
      </TabsLayout>
...
export default SignalBandsDemo;
