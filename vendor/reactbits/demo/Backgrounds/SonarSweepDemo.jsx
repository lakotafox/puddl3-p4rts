...
import SonarSweep from '../../content/Backgrounds/SonarSweep/SonarSweep';
import { sonarSweep } from '../../constants/code/Backgrounds/sonarSweepCode';
  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        type: 'number',
        default: '0.5',
        description: 'Zoom level of the sonar-sweep pattern.'
      },
      {
        name: 'ringCount',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '1.0',
        description: 'Number of sweep beams around the sonar-sweep.'
      },
      {
        name: 'color',
        type: 'string',
        default: '"#9f29ff"',
        description: 'Primary sonar-sweep color in HEX format.'
      },
      {
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={sonarSweep} componentName="SonarSweep" />
        </CodeTab>
      </TabsLayout>
