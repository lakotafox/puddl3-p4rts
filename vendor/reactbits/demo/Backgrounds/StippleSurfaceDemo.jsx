...
import StippleSurface from '../../content/Backgrounds/StippleSurface/StippleSurface';
import { stippleSurface } from '../../constants/code/Backgrounds/stippleSurfaceCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={stippleSurface} componentName="StippleSurface" />
        </CodeTab>
      </TabsLayout>
...
export default StippleSurfaceDemo;
