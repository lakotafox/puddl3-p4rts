...
import { hyperspeedPresets } from '../../content/Backgrounds/WarpDrive/HyperSpeedPresets';
...
import WarpDrive from '../../content/Backgrounds/WarpDrive/WarpDrive';
import { warpDrive } from '../../constants/code/Backgrounds/warpDriveCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box
            ...
            mb={4}
          >
            <WarpDrive effectOptions={hyperspeedPresets[activePreset]} />

            {/* For Demo Purposes Only */}
            <BackgroundContent pillText="New Background" headline="Click & hold to see the real magic of warp-drive!" />
          </Box>

          <Flex justify="flex-end" mt={2} mb={-2}>
            <OpenInStudioButton
              backgroundId="warp-drive"
        ...
        <CodeTab>
          <CodeExample codeObject={warpDrive} componentName="WarpDrive" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
