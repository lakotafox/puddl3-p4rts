...
import { wireframeSweep } from '@/constants/code/Backgrounds/wireframeSweepCode';
import { WireframeSweep } from '@/content/Backgrounds/WireframeSweep/WireframeSweep';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={wireframeSweep} componentName="WireframeSweep" />
        </CodeTab>
      </TabsLayout>
...
export default WireframeSweepDemo;
