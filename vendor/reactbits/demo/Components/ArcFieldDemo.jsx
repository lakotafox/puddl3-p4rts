...
import ArcField from '../../content/Components/ArcField/ArcField';
import { arcField } from '../../constants/code/Components/arcFieldCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={arcField} componentName="ArcField" />
        </CodeTab>
      </TabsLayout>
