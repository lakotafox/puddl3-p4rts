...
import BeaconTile from '../../content/Components/BeaconTile/BeaconTile';
import { beaconTile } from '../../constants/code/Components/beaconTileCode';

const DEFAULT_PROPS = {
  spotlightColor: '#ffffff40'
};

const BeaconTileDemo = () => {
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" py={10}>
            <BeaconTile className="custom-beacon-tile" spotlightColor={spotlightColor}>
        ...
        <CodeTab>
          <CodeExample codeObject={beaconTile} componentName="BeaconTile" />
        </CodeTab>
      </TabsLayout>
