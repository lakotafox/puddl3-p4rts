...
import { billboardStream } from '../../constants/code/Components/billboardStreamCode';
import BillboardStream from '../../content/Components/BillboardStream/BillboardStream';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={billboardStream} componentName="BillboardStream" />
        </CodeTab>
      </TabsLayout>
...
export default BillboardStreamDemo;
