...
import { bitmapPanel } from '../../constants/code/Components/bitmapPanelCode';
import BitmapPanel from '../../content/Components/BitmapPanel/BitmapPanel';

const DEFAULT_PROPS = {
  variant: 'default'
};

const BitmapPanelDemo = () => {
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={bitmapPanel} componentName="BitmapPanel" />
        </CodeTab>
      </TabsLayout>
...
export default BitmapPanelDemo;
