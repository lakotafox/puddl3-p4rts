...
import logoDark from '../../assets/logos/foxbits-logo-small-black.svg';
import logoLight from '../../assets/logos/foxbits-logo-small.svg';

import CapsuleTabs from '../../content/Components/CapsuleTabs/CapsuleTabs';
import { capsuleTabs } from '../../constants/code/Components/capsuleTabsCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={capsuleTabs} componentName="CapsuleTabs" />
        </CodeTab>
      </TabsLayout>
...
export default CapsuleTabsDemo;
