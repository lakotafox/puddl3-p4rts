...
import ChoiceDial from '../../content/Components/ChoiceDial/ChoiceDial';
import { choiceDial } from '../../constants/code/Components/choiceDialCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            <ChoiceDial {...props} items={DEMO_ITEMS} />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={choiceDial} componentName="ChoiceDial" />
        </CodeTab>
      </TabsLayout>
