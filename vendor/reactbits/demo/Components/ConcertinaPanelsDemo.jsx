...
import { concertinaPanels } from '../../constants/code/Components/concertinaPanelsCode';
import ConcertinaPanels from '../../content/Components/ConcertinaPanels/ConcertinaPanels';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={concertinaPanels} componentName="ConcertinaPanels" />
        </CodeTab>
      </TabsLayout>
...
export default ConcertinaPanelsDemo;
