...
import logo from '../../assets/logos/foxbits-logo-small.svg';

import InkCurrents from '@/content/Backgrounds/InkCurrents/InkCurrents';
import { crystalPanel } from '../../constants/code/Components/crystalPanelCode';
import CrystalPanel from '../../content/Components/CrystalPanel/CrystalPanel';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
            ...
            {selectedExample === 'landingPage' && (
              <>
                ...
                <Box
                  ...
                  pointerEvents="none"
                >
                  <CrystalPanel height={40} width={160} {...commonGlassProps}>
                    <TbBackground />
                  ...
                  <Box display="flex" gap={4} mt={8} alignItems="center">
                    ...
                    <CrystalPanel height={44.98} width={154.31} borderRadius={100} {...commonGlassProps}>
                      Learn More
                    </CrystalPanel>
                  </Box>
                </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={crystalPanel} componentName="CrystalPanel" />
        </CodeTab>
      </TabsLayout>
...
export default CrystalPanelDemo;
