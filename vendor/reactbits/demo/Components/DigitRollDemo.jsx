...
import DigitRoll from '../../content/Components/DigitRoll/DigitRoll';
import { digitRoll } from '../../constants/code/Components/digitRollCode';
    ...
    () => [
      {
        ...
        description: 'The numeric value to display in the digit-roll.'
      },
      {
        name: 'fontSize',
        type: 'number',
        default: '100',
        description: 'The base font size used for the digit-roll digits.'
      },
      {
        name: 'padding',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        default: '4',
        description: 'The border radius (in pixels) for the digit-roll container.'
      },
      {
        name: 'horizontalPadding',
        type: 'number',
        default: '8',
        description: 'The horizontal padding (in pixels) for the digit-roll container.'
      },
      {
        name: 'textColor',
        type: 'string',
        default: "'white'",
        description: 'The text color for the digit-roll digits.'
      },
      {
        name: 'fontWeight',
        type: 'string | number',
        default: "'bold'",
        description: 'The font weight of the digit-roll digits.'
      },
      {
        name: 'containerStyle',
      ...
      },
      {
        ...
        type: 'React.CSSProperties',
        default: '{}',
        description: 'Custom inline styles for the digit-roll element.'
      },
      {
        name: 'digitStyle',
        type: 'React.CSSProperties',
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={digitRoll} componentName="DigitRoll" />
        </CodeTab>
      </TabsLayout>
