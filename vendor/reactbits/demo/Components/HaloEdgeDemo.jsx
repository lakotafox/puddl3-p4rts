...
import HaloEdge from '../../content/Components/HaloEdge/HaloEdge';
import { haloEdge } from '../../constants/code/Components/haloEdgeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={haloEdge} componentName="HaloEdge" />
        </CodeTab>
      </TabsLayout>
