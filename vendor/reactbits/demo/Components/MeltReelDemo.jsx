...
import MeltReel from '../../content/Components/MeltReel/MeltReel';
import { meltReel } from '../../constants/code/Components/meltReelCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            <MeltReel {...props} items={DEMO_ITEMS} />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={meltReel} componentName="MeltReel" />
        </CodeTab>
      </TabsLayout>
