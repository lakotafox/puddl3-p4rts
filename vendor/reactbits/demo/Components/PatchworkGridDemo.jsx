...
import { patchworkGrid } from '../../constants/code/Components/patchworkGridCode';
import PatchworkGrid from '../../content/Components/PatchworkGrid/PatchworkGrid';
    ...
    () => [
      {
        ...
        default: 'required',
        description:
          'Array of items to display in the patchwork-grid layout. Each item should have id, img, url, and height properties.'
      },
      {
        name: 'ease',
        type: 'string',
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={patchworkGrid} componentName="PatchworkGrid" />
        </CodeTab>
      </TabsLayout>
...
export default PatchworkGridDemo;
