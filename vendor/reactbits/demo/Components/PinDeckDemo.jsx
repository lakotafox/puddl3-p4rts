...
import { pinDeck } from '../../constants/code/Components/pinDeckCode';
import PinDeck, { PinDeckItem } from '../../content/Components/PinDeck/PinDeck';
    ...
    () => [
      {
        ...
        type: 'ReactNode',
        default: 'required',
        description: 'The content to be displayed in the scroll stack. Should contain PinDeckItem components.'
      },
      {
        name: 'className',
        type: 'string',
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={400} p={0} overflow="hidden">
            ...
            <PinDeck
              ...
              className="pin-deck-demo-container"
            ...
            >
              <PinDeckItem itemClassName="pin-deck-card-demo ssc-demo-1">
              ...
              <PinDeckItem itemClassName="pin-deck-card-demo ssc-demo-2">
                <h3>Animations</h3>
              ...
              <PinDeckItem itemClassName="pin-deck-card-demo ssc-demo-3">
                <h3>Components</h3>
              ...
              <PinDeckItem itemClassName="pin-deck-card-demo ssc-demo-4">
                <h3>Backgrounds</h3>
        ...
        <CodeTab>
          <CodeExample codeObject={pinDeck} componentName="PinDeck" />
        </CodeTab>
      </TabsLayout>
