...
import RimlightButton from '../../content/Components/RimlightButton/RimlightButton';
import { rimlightButton } from '../../constants/code/Components/rimlightButtonCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={400} overflow="hidden" display="flex" alignItems="center" justifyContent="center">
            <RimlightButton {...props}>Get Started</RimlightButton>
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={rimlightButton} componentName="RimlightButton" />
        </CodeTab>
      </TabsLayout>
...
export default RimlightButtonDemo;
