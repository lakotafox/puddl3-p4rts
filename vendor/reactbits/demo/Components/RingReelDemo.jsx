...
import { ringReel } from '../../constants/code/Components/ringReelCode';
import RingReel from '../../content/Components/RingReel/RingReel';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={ringReel} componentName="RingReel" />
        </CodeTab>
      </TabsLayout>
