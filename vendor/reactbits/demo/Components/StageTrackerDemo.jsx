...
import StageTracker, { Step } from '../../content/Components/StageTracker/StageTracker';
    ...
    () => [
      {
        ...
        type: 'ReactNode',
        default: '—',
        description: 'The Step components (or any custom content) rendered inside the stage-tracker.'
      },
      {
        name: 'initialStep',
        type: 'number',
        default: '1',
        description: 'The first step to display when the stage-tracker is initialized.'
      },
      {
        name: 'onStepChange',
      ...
      },
      {
        ...
        type: '() => void',
        default: '() => {}',
        description: 'Callback fired when the stage-tracker completes its final step.'
      },
      {
  ...
  return (
    ...
    >
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={stageTracker} componentName="StageTracker" />
        </CodeTab>
      </TabsLayout>
    </ComponentPropsProvider>
  );
