...
import SwipeDeck from '../../content/Components/SwipeDeck/SwipeDeck';
import { swipeDeck } from '../../constants/code/Components/swipeDeckCode';
  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'When enabled, the swipe-deck also shifts to the next card on click.'
      },
      {
        name: 'cards',
        type: 'ReactNode[]',
        default: '[]',
        description: 'The array of card elements to display in the swipe-deck.'
      },
      {
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'When enabled, the swipe-deck automatically cycles through cards.'
      },
      {
        name: 'autoplayDelay',
        type: 'number',
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'When enabled, autoplay pauses when hovering over the swipe-deck.'
      }
    ],
    []
  );
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={swipeDeck} componentName="SwipeDeck" />
        </CodeTab>
      </TabsLayout>
