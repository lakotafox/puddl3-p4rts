...
import { tileStream } from '../../constants/code/Components/tileStreamCode';
import TileStream from '../../content/Components/TileStream/TileStream';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={tileStream} componentName="TileStream" />
        </CodeTab>
      </TabsLayout>
