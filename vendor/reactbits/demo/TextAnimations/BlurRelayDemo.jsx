...
import BlurRelay from '../../content/TextAnimations/BlurRelay/BlurRelay';
import { blurRelay } from '../../constants/code/TextAnimations/blurRelayCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={blurRelay} componentName="BlurRelay" />
        </CodeTab>
      </TabsLayout>
