...
import DustType from '../../content/TextAnimations/DustType/DustType';
import { dustType } from '../../constants/code/TextAnimations/dustTypeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={dustType} componentName="DustType" />
        </CodeTab>
      </TabsLayout>
