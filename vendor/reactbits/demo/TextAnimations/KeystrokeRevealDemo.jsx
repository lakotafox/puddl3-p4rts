...
import KeystrokeReveal from '../../content/TextAnimations/KeystrokeReveal/KeystrokeReveal';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        <PreviewTab>
          ...
          >
            <KeystrokeReveal
              ...
              className="custom-keystroke-reveal"
            />
          </Box>
        ...
        <CodeTab>
          <CodeExample codeObject={keystrokeReveal} componentName="KeystrokeReveal" />
        </CodeTab>
      </TabsLayout>
...
export default KeystrokeRevealDemo;
