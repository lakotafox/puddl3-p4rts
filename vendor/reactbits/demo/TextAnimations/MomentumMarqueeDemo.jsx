...
import MomentumMarquee from '../../content/TextAnimations/MomentumMarquee/MomentumMarquee';
import { momentumMarquee } from '../../constants/code/TextAnimations/momentumMarqueeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={momentumMarquee} componentName="MomentumMarquee" />
        </CodeTab>
      </TabsLayout>
...
export default MomentumMarqueeDemo;
