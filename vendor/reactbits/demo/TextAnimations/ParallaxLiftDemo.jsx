...
import ParallaxLift from '../../content/TextAnimations/ParallaxLift/ParallaxLift';
import { parallaxLift } from '../../constants/code/TextAnimations/parallaxLiftCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={parallaxLift} componentName="ParallaxLift" />
        </CodeTab>
      </TabsLayout>
...
export default ParallaxLiftDemo;
