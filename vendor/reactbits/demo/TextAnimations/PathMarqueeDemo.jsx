...
import PathMarquee from '../../content/TextAnimations/PathMarquee/PathMarquee';
import { pathMarquee } from '../../constants/code/TextAnimations/pathMarqueeCode';
...
const PathMarqueeDemo = () => {
  ...
  const propData = useMemo(
    () => [
      { name: 'text', type: 'string', default: '"TEXT ✦ LOOPING"', description: 'The phrase repeated along the curve.' },
      {
        name: 'shape',
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={pathMarquee} componentName="PathMarquee" />
        </CodeTab>
      </TabsLayout>
...
export default PathMarqueeDemo;
