...
import PhraseFlip from '../../content/TextAnimations/PhraseFlip/PhraseFlip';
import { phraseFlip } from '../../constants/code/TextAnimations/phraseFlipCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" minH={400} maxH={400} overflow="hidden">
            <div className="phrase-flip-demo">
              <LayoutGroup>
                <motion.p className="phrase-flip-ptag" layout>
                  <motion.span
                  ...
                  <PhraseFlip
                    key={key}
                    texts={words}
                    mainClassName="phrase-flip-main"
                    staggerFrom={staggerFrom}
                    initial={{ y: '100%' }}
                    animate={{ y: 0 }}
                    exit={{ y: '-120%' }}
                    staggerDuration={staggerDuration}
                    splitLevelClassName="phrase-flip-split"
                    splitBy={splitBy}
                    transition={{ type: 'spring', damping: 30, stiffness: 400 }}
        ...
        <CodeTab>
          <CodeExample codeObject={phraseFlip} componentName="PhraseFlip" />
        </CodeTab>
      </TabsLayout>
