...
import StaticType from '../../content/TextAnimations/StaticType/StaticType';
import { staticType } from '../../constants/code/TextAnimations/staticTypeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={staticType} componentName="StaticType" />
        </CodeTab>
      </TabsLayout>
