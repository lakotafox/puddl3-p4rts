...
import StencilTitle from '../../content/TextAnimations/StencilTitle/StencilTitle';
import { stencilTitle } from '../../constants/code/TextAnimations/stencilTitleCode';

const DEMO_IMAGE = 'https://images.unsplash.com/photo-1500673587002-1d2548cfba1b?q=80&w=1600&auto=format&fit=crop';
const DEMO_VIDEO = '/assets/video/stencil-title.mp4';

const DEFAULT_PROPS = {
  text: 'SEE THROUGH THE WORDS',
  mediaType: 'video',
  fillScale: 1.25,
  parallax: 26,
  drift: 18,
...
const StencilTitleDemo = () => {
  ...
  const propData = useMemo(
    () => [
      { name: 'text', type: 'string', default: "'SEE THROUGH THE WORDS'", description: 'Heading copy.' },
      {
        name: 'tag',
        type: 'string',
        default: "'h2'",
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        <PreviewTab>
          ...
          <Customize>
            <PreviewSelect
              title="Text"
              options={[
                { label: 'Details', value: 'SEE THROUGH THE WORDS' },
        ...
        <CodeTab>
          <CodeExample codeObject={stencilTitle} componentName="StencilTitle" />
        </CodeTab>
      </TabsLayout>
...
export default StencilTitleDemo;
