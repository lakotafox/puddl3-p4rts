...
import TerminalType from '@content/TextAnimations/TerminalType/TerminalType';
import { terminalType } from '../../constants/code/TextAnimations/terminalTypeCode';
  ...
  return (
    <ComponentPropsProvider props={props} defaultProps={DEFAULT_PROPS} resetProps={resetProps} hasChanges={hasChanges}>
      <TabsLayout>
        ...
        <CodeTab>
          <CodeExample codeObject={terminalType} componentName="TerminalType" />
        </CodeTab>
      </TabsLayout>
...
export default TerminalTypeDemo;
