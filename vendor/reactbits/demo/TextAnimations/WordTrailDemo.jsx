...
import WordTrail from '../../content/TextAnimations/WordTrail/WordTrail';
import { wordTrail } from '../../constants/code/TextAnimations/wordTrailCode';
      ...
      <TabsLayout>
        <PreviewTab>
          <Box position="relative" className="demo-container" h={400} overflow="hidden">
            <WordTrail key={key} text={text} followMouseDirection={followMouseDirection} randomFloat={randomFloat} />
            <Text
              pointerEvents="none"
              position="absolute"
              textAlign="center"
        ...
        <CodeTab>
          <CodeExample codeObject={wordTrail} componentName="WordTrail" />
        </CodeTab>
      </TabsLayout>
