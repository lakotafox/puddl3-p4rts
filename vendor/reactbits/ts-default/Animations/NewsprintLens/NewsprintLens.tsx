...
import './NewsprintLens.css';

const DEFAULT_SRC = 'https://picsum.photos/seed/newsprint-lens/1200/800';
...
export interface NewsprintLensProps {
  src?: string;
  inkColor?: string;
  paperColor?: string;
  mode?: Mode;
...
const NewsprintLens = ({
  ...
  return (
    <div ref={containerRef} className={`newsprint-lens ${className}`.trim()} style={{ borderRadius, ...style }} />
  );
};

export default NewsprintLens;
