...
export default function RetroFlurry({
  color = '#ffffff',
  flakeSize = 0.01,
  minFlakeSize = 1.25,
  pixelResolution = 200,
  ...
  return <div ref={containerRef} className={`retro-flurry-container ${className}`} style={style} />;
}
