...
vec3 retroStatic(vec2 uv, vec3 color) {
...
void mainImage(in vec4 inputColor, in vec2 uv, out vec4 outputColor) {
  ...
  color.rgb = retroStatic(uv, color.rgb);
  outputColor = color;
}
`;
...
interface RetroStaticedWavesProps {
  waveSpeed: number;
...
export default function RetroStatic({
  waveSpeed = 0.05,
  waveFrequency = 3,
  waveAmplitude = 0.3,
  ...
  return (
    <Canvas
      className="retro-static-container"
