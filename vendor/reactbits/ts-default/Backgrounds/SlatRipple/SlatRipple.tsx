...
import './SlatRipple.css';

export type SlatRippleOrientation = 'horizontal' | 'vertical';

export interface SlatRippleProps {
  color1?: string;
  color2?: string;
  color3?: string;
  columns?: number;
  ...
  contrast?: number;
  opacity?: number;
  orientation?: SlatRippleOrientation;
  alternate?: boolean;
...
const ctxMap = new WeakMap<HTMLDivElement, SlatRippleCtx>();

const SlatRipple: React.FC<SlatRippleProps> = ({
  color1 = '#FF9FFC',
  color2 = '#5227FF',
  color3 = '#B497CF',
  columns = 14,
  ...
  return <div ref={containerRef} className={`slat-ripple-container ${className}`.trim()} />;
};

export default SlatRipple;
