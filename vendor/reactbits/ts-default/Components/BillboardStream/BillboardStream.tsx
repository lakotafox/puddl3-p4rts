...
interface BillboardStreamProps extends React.HTMLAttributes<HTMLDivElement> {
  items?: string[];
  planeWidth?: number;
  planeHeight?: number;
  distortion?: number;
...
export default function BillboardStream({
  items = [],
  planeWidth = 320,
  planeHeight = 320,
  distortion = 3,
