...
export interface LockOnPointerProps {
...
const LockOnPointer: React.FC<LockOnPointerProps> = ({
  ...
  useEffect(() => {
    ...
    cornersRef.current = cursor.querySelectorAll<HTMLDivElement>('.lock-on-pointer-corner');
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="lock-on-pointer-corner absolute top-1/2 left-1/2 w-3 h-3 border-[3px] -translate-x-[150%] -translate-y-[150%] border-r-0 border-b-0"
        style={{ willChange: 'transform', borderColor: cursorColor }}
      />
      <div
        className="lock-on-pointer-corner absolute top-1/2 left-1/2 w-3 h-3 border-[3px] translate-x-1/2 -translate-y-[150%] border-l-0 border-b-0"
        style={{ willChange: 'transform', borderColor: cursorColor }}
      />
      <div
        className="lock-on-pointer-corner absolute top-1/2 left-1/2 w-3 h-3 border-[3px] translate-x-1/2 translate-y-1/2 border-l-0 border-t-0"
        style={{ willChange: 'transform', borderColor: cursorColor }}
      />
      <div
        className="lock-on-pointer-corner absolute top-1/2 left-1/2 w-3 h-3 border-[3px] -translate-x-[150%] translate-y-1/2 border-r-0 border-t-0"
        style={{ willChange: 'transform', borderColor: cursorColor }}
      />
    </div>
  );
