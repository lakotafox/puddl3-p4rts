  ...
  return (
    ...
    >
      ...
      {showCaptions && hasCaptions && (
        <div
          className="melt-reel-caption pointer-events-none absolute bottom-[22px] left-[22px] z-[2] grid max-w-[70%]"
          aria-live="polite"
        >
          {items.map((item, i) =>
            item.caption ? (
